...
@DebugMetadata(mo21913c = "kotlin.sequences.SequencesKt___SequencesKt$zipWithNext$2", mo21914f = "_Sequences.kt", mo21915i = {0, 0, 0, 0}, mo21916l = {1871}, mo21917m = "invokeSuspend", mo21918n = {"$this$result", "iterator", "current", "next"}, mo21919s = {"L$0", "L$1", "L$2", "L$3"})
...
final class SequencesKt___SequencesKt$zipWithNext$2 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        sequencesKt___SequencesKt$zipWithNext$2.f2783p$ = (SequenceScope) obj;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            SequenceScope sequenceScope2 = this.f2783p$;
