        ...
        while (true) {
            ...
            try {
                ...
                if (invokeSuspend != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    obj = Result.m3009constructorimpl(invokeSuspend);
                ...
                obj = Result.m3009constructorimpl(ResultKt.createFailure(th));
            }
        }
    }
