...
public final class DurationKt {
    ...
    private static final double m3989timesmvk6XK0(int i, double d) {
        return Duration.m3971timesimpl(d, i);
    }
    ...
    private static final double m3988timeskIfJnKk(double d, double d2) {
        return Duration.m3970timesimpl(d2, d);
    }
    ...
    public static final double toDuration(double d, @NotNull TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return Duration.m3944constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
