...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    @InlineOnly
    /* renamed from: ln */
    private static final double m2949ln(double d) {
        return Math.log(d);
    }
    ...
    @InlineOnly
    /* renamed from: ln */
    private static final float m2950ln(float f) {
