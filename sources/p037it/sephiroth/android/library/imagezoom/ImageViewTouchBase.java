package p037it.sephiroth.android.library.imagezoom;
...
import p037it.sephiroth.android.library.easing.Cubic;
import p037it.sephiroth.android.library.easing.Easing;
import p037it.sephiroth.android.library.imagezoom.graphics.FastBitmapDrawable;
import p037it.sephiroth.android.library.imagezoom.utils.IDisposable;
...
public abstract class ImageViewTouchBase extends ImageView implements IDisposable {
    ...
    public android.graphics.RectF getCenter(android.graphics.Matrix r6, boolean r7, boolean r8) {
        ...
        L_0x006a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p037it.sephiroth.android.library.imagezoom.ImageViewTouchBase.getCenter(android.graphics.Matrix, boolean, boolean):android.graphics.RectF");
    }
