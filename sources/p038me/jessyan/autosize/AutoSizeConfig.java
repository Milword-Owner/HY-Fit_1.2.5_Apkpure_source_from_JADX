...
import p038me.jessyan.autosize.external.ExternalAdaptManager;
import p038me.jessyan.autosize.unit.Subunits;
import p038me.jessyan.autosize.unit.UnitsManager;
import p038me.jessyan.autosize.utils.AutoSizeLog;
import p038me.jessyan.autosize.utils.Preconditions;
import p038me.jessyan.autosize.utils.ScreenUtils;
...
public final class AutoSizeConfig {
    ...
    public AutoSizeConfig init(final Application application, boolean z, AutoAdaptStrategy autoAdaptStrategy) {
        ...
        AutoSizeLog.m2951d("designWidthInDp = " + this.mDesignWidthInDp + ", designHeightInDp = " + this.mDesignHeightInDp + ", screenWidth = " + this.mScreenWidth + ", screenHeight = " + this.mScreenHeight);
            ...
            public void onConfigurationChanged(Configuration configuration) {
                if (configuration != null) {
                    if (configuration.fontScale > 0.0f) {
                        ...
                        AutoSizeLog.m2951d("initScaledDensity = " + AutoSizeConfig.this.mInitScaledDensity + " on ConfigurationChanged");
                    }
        ...
        AutoSizeLog.m2951d("initDensity = " + this.mInitDensity + ", initScaledDensity = " + this.mInitScaledDensity);
