...
import p038me.jessyan.autosize.unit.Subunits;
import p038me.jessyan.autosize.utils.AutoSizeLog;
import p038me.jessyan.autosize.utils.Preconditions;
...
public final class AutoSize {
    ...
    public static void autoConvertDensity(Activity activity, float f, boolean z) {
        ...
        int i7 = z ? round | 1073741824 : round & -1073741825;
        int i8 = AutoSizeConfig.getInstance().isUseDeviceSize() ? i7 | Integer.MIN_VALUE : i7 & Integer.MAX_VALUE;
        DisplayMetricsInfo displayMetricsInfo = mCache.get(i8);
    ...
    public static void cancelAdapt(Activity activity) {
        ...
        int i = C26291.$SwitchMap$me$jessyan$autosize$unit$Subunits[AutoSizeConfig.getInstance().getUnitsManager().getSupportSubunits().ordinal()];
        if (i != 1) {
            if (i == 2) {
                f = 25.4f;
            }
    ...
    static /* synthetic */ class C26291 {
        ...
        static {
            /*
                me.jessyan.autosize.unit.Subunits[] r0 = p038me.jessyan.autosize.unit.Subunits.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ...
                me.jessyan.autosize.unit.Subunits r1 = p038me.jessyan.autosize.unit.Subunits.PT     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = $SwitchMap$me$jessyan$autosize$unit$Subunits     // Catch:{ NoSuchFieldError -> 0x001f }
                me.jessyan.autosize.unit.Subunits r1 = p038me.jessyan.autosize.unit.Subunits.MM     // Catch:{ NoSuchFieldError -> 0x001f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r0 = $SwitchMap$me$jessyan$autosize$unit$Subunits     // Catch:{ NoSuchFieldError -> 0x002a }
                me.jessyan.autosize.unit.Subunits r1 = p038me.jessyan.autosize.unit.Subunits.NONE     // Catch:{ NoSuchFieldError -> 0x002a }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x002a }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x002a }
            L_0x002a:
                int[] r0 = $SwitchMap$me$jessyan$autosize$unit$Subunits     // Catch:{ NoSuchFieldError -> 0x0035 }
                me.jessyan.autosize.unit.Subunits r1 = p038me.jessyan.autosize.unit.Subunits.IN     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p038me.jessyan.autosize.AutoSize.C26291.<clinit>():void");
        }
    }
    ...
    private static void setDensity(DisplayMetrics displayMetrics, float f, int i, float f2, float f3) {
        ...
        int i2 = C26291.$SwitchMap$me$jessyan$autosize$unit$Subunits[AutoSizeConfig.getInstance().getUnitsManager().getSupportSubunits().ordinal()];
        if (i2 == 1) {
