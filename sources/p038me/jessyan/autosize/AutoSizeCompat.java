...
public final class AutoSizeCompat {
    ...
    public static void cancelAdapt(Resources resources) {
        ...
        int i = C26301.$SwitchMap$me$jessyan$autosize$unit$Subunits[AutoSizeConfig.getInstance().getUnitsManager().getSupportSubunits().ordinal()];
        if (i != 1) {
            if (i == 2) {
                f = 25.4f;
            }
    ...
    static /* synthetic */ class C26301 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p038me.jessyan.autosize.AutoSizeCompat.C26301.<clinit>():void");
        }
    }
    ...
    private static void setDensity(DisplayMetrics displayMetrics, float f, int i, float f2, float f3) {
        ...
        int i2 = C26301.$SwitchMap$me$jessyan$autosize$unit$Subunits[AutoSizeConfig.getInstance().getUnitsManager().getSupportSubunits().ordinal()];
        if (i2 == 1) {
