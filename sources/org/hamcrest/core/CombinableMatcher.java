...
public class CombinableMatcher<T> extends TypeSafeDiagnosingMatcher<T> {
    ...
    /* renamed from: or */
    public CombinableMatcher<T> mo34278or(Matcher<? super T> matcher2) {
    ...
    public static final class CombinableEitherMatcher<X> {
        ...
        /* renamed from: or */
        public CombinableMatcher<X> mo34280or(Matcher<? super X> matcher) {
            return new CombinableMatcher(this.first).mo34278or(matcher);
        }
    }
}
