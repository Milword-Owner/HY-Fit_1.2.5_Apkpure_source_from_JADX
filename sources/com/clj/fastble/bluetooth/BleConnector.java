    ...
    private static final class ConnectorHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 49) {
                ...
                removeMessages(49);
                BleWriteCallback bleWriteCallback2 = (BleWriteCallback) message.obj;
                int i2 = message.getData().getInt(BleMsg.KEY_WRITE_BUNDLE_STATUS);
                if (bleWriteCallback2 == null) {
                    return;
                }
                if (i2 == 0) {
                    bleWriteCallback2.onWriteSuccess();
                } else {
                    bleWriteCallback2.onWriteFailure(new GattException(i2));
                }
            } else if (i == 65) {
                ...
                BleReadCallback bleReadCallback2 = (BleReadCallback) message.obj;
                Bundle data = message.getData();
                int i3 = data.getInt(BleMsg.KEY_READ_BUNDLE_STATUS);
                byte[] byteArray = data.getByteArray(BleMsg.KEY_READ_BUNDLE_VALUE);
                if (bleReadCallback2 == null) {
                    return;
                }
                if (i3 == 0) {
                    bleReadCallback2.onReadSuccess(byteArray);
                } else {
                    bleReadCallback2.onReadFailure(new GattException(i3));
                }
            } else if (i == 81) {
                ...
                BleRssiCallback bleRssiCallback2 = (BleRssiCallback) message.obj;
                Bundle data2 = message.getData();
                int i4 = data2.getInt(BleMsg.KEY_READ_RSSI_BUNDLE_STATUS);
                int i5 = data2.getInt(BleMsg.KEY_READ_RSSI_BUNDLE_VALUE);
                if (bleRssiCallback2 == null) {
                    return;
                }
                if (i4 == 0) {
                ...
                switch (i) {
                    ...
                    case 19:
                        BleNotifyCallback bleNotifyCallback3 = (BleNotifyCallback) message.obj;
                        byte[] byteArray2 = message.getData().getByteArray(BleMsg.KEY_NOTIFY_BUNDLE_VALUE);
                        if (bleNotifyCallback3 != null) {
                            bleNotifyCallback3.onCharacteristicChanged(byteArray2);
                            return;
                        }
                        return;
                    default:
                        switch (i) {
                            ...
                            case 35:
                                BleIndicateCallback bleIndicateCallback3 = (BleIndicateCallback) message.obj;
                                byte[] byteArray3 = message.getData().getByteArray(BleMsg.KEY_INDICATE_BUNDLE_VALUE);
                                if (bleIndicateCallback3 != null) {
                                    bleIndicateCallback3.onCharacteristicChanged(byteArray3);
                                    return;
                                }
                                return;
                            default:
                ...
                BleMtuChangedCallback bleMtuChangedCallback2 = (BleMtuChangedCallback) message.obj;
                Bundle data3 = message.getData();
                int i8 = data3.getInt(BleMsg.KEY_SET_MTU_BUNDLE_STATUS);
                int i9 = data3.getInt(BleMsg.KEY_SET_MTU_BUNDLE_VALUE);
                if (bleMtuChangedCallback2 == null) {
                    return;
                }
                if (i8 == 0) {
