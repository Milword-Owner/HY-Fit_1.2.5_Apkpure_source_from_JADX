...
public final class RGBLuminanceSource extends LuminanceSource {
    ...
    public byte[] getRow(int i, byte[] bArr) {
        ...
        System.arraycopy(this.luminances, ((i + this.f2835top) * this.dataWidth) + this.left, bArr, 0, width);
        return bArr;
    }
    ...
    public LuminanceSource crop(int i, int i2, int i3, int i4) {
        return new RGBLuminanceSource(this.luminances, this.dataWidth, this.dataHeight, this.left + i, this.f2835top + i2, i3, i4);
    }
}
