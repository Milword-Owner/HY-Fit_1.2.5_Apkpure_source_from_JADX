...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f1636FS = '\u001c';

    /* renamed from: GS */
    private static final char f1637GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f1638NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f1639RS = '\u001e';
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, str + f1637GS + format + f1637GS + format2 + f1637GS);
            } else {
                sb.insert(0, str + f1637GS + format + f1637GS + format2 + f1637GS);
            }
        } else if (i == 4) {
