...
public final class zzay {
    ...
    private static final Feature zzdi = new Feature("auth_api_credentials_save_account_linking_token", 2);
    public static final Feature[] zzdj = {zzdc, zzdd, zzde, zzdf, zzdg, zzdh, zzdi};
}
