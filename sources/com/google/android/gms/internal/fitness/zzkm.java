...
interface zzkm {
    ...
    <K, V> void zza(int i, zzib<K, V> zzib, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzja zzja) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzja zzja) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzja zzja) throws IOException;

    void zzb(int i, List<zzfx> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzja zzja) throws IOException;
