...
public enum zzkn {
    ...
    private static final zzfc<zzkn> zzaiw = null;
    private static final zzfh<Integer> zzaix = null;
    private final int zzaiy;
    private final String zzaiz;

    private zzkn(int i, String str) {
        this.zzaiy = i;
        this.zzaiz = str;
    }
    ...
    public static zzkn zza(int i, zzkn zzkn) {
        return (i < 0 || i >= zzaiw.size()) ? zzkn : (zzkn) zzaiw.get(i);
    }

    static {
        int i;
        ArrayList arrayList = new ArrayList(Collections.nCopies(values().length, (Object) null));
        for (zzkn zzkn : values()) {
            arrayList.set(zzkn.zzaiy, zzkn);
        }
