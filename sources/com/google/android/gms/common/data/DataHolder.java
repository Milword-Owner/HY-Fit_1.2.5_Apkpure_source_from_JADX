...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @SafeParcelable.VersionField(mo19520id = 1000)
    private final int zali;
    @SafeParcelable.Field(getter = "getColumns", mo19514id = 1)
    private final String[] zalt;
    private Bundle zalu;
    @SafeParcelable.Field(getter = "getWindows", mo19514id = 2)
    private final CursorWindow[] zalv;
    @SafeParcelable.Field(getter = "getStatusCode", mo19514id = 3)
    private final int zalw;
    @SafeParcelable.Field(getter = "getMetadata", mo19514id = 4)
    ...
    DataHolder(@SafeParcelable.Param(mo19517id = 1000) int i, @SafeParcelable.Param(mo19517id = 1) String[] strArr, @SafeParcelable.Param(mo19517id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(mo19517id = 3) int i2, @SafeParcelable.Param(mo19517id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zama = true;
        this.zali = i;
        this.zalt = strArr;
