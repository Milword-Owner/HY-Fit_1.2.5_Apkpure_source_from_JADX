...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getStatusCode", mo19514id = 1)
    private final int zzr;
    @SafeParcelable.Field(getter = "getPendingIntent", mo19514id = 3)
    @Nullable
    private final PendingIntent zzs;
    @SafeParcelable.Field(getter = "getStatusMessage", mo19514id = 2)
    @Nullable
    private final String zzt;

    @SafeParcelable.Constructor
    @KeepForSdk
    Status(@SafeParcelable.Param(mo19517id = 1000) int i, @SafeParcelable.Param(mo19517id = 1) int i2, @SafeParcelable.Param(mo19517id = 2) @Nullable String str, @SafeParcelable.Param(mo19517id = 3) @Nullable PendingIntent pendingIntent) {
        this.zzq = i;
        this.zzr = i2;
        this.zzt = str;
