...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo19514id = 2)
    private final int zzr;
    @SafeParcelable.Field(getter = "getResolution", mo19514id = 3)
    private final PendingIntent zzs;
    @SafeParcelable.Field(getter = "getErrorMessage", mo19514id = 4)
    private final String zzt;

    @SafeParcelable.Constructor
    ConnectionResult(@SafeParcelable.Param(mo19517id = 1) int i, @SafeParcelable.Param(mo19517id = 2) int i2, @SafeParcelable.Param(mo19517id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo19517id = 4) String str) {
        this.zzq = i;
        this.zzr = i2;
