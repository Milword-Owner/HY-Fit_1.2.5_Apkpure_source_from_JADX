...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getBundle", mo19514id = 3)
    private Bundle mBundle;
    @SafeParcelable.Field(getter = "getType", mo19514id = 2)
    private int mType;
    @SafeParcelable.VersionField(mo19520id = 1)
    private final int versionCode;

    @SafeParcelable.Constructor
    GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(mo19517id = 1) int i, @SafeParcelable.Param(mo19517id = 2) int i2, @SafeParcelable.Param(mo19517id = 3) Bundle bundle) {
        this.versionCode = i;
        this.mType = i2;
        this.mBundle = bundle;
    }
