...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "isForceCodeForRefreshToken", mo19514id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getServerClientId", mo19514id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getHostedDomain", mo19514id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getExtensions", mo19514id = 9)
    public ArrayList<GoogleSignInOptionsExtensionParcelable> zaad;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getLogSessionId", mo19514id = 10)
    public String zaae;
    private Map<Integer, GoogleSignInOptionsExtensionParcelable> zaaf;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getScopes", mo19514id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getAccount", mo19514id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isIdTokenRequested", mo19514id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isServerAuthCodeRequested", mo19514id = 5)
    ...
    GoogleSignInOptions(@SafeParcelable.Param(mo19517id = 1) int i, @SafeParcelable.Param(mo19517id = 2) ArrayList<Scope> arrayList, @SafeParcelable.Param(mo19517id = 3) Account account, @SafeParcelable.Param(mo19517id = 4) boolean z, @SafeParcelable.Param(mo19517id = 5) boolean z2, @SafeParcelable.Param(mo19517id = 6) boolean z3, @SafeParcelable.Param(mo19517id = 7) String str, @SafeParcelable.Param(mo19517id = 8) String str2, @SafeParcelable.Param(mo19517id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2, @SafeParcelable.Param(mo19517id = 10) String str3) {
