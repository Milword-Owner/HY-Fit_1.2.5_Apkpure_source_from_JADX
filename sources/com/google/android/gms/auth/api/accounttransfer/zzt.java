...
public class zzt extends zzaz {
    ...
    @SafeParcelable.Field(getter = "getAccountType", mo19514id = 2)
    private String zzbn;
    @SafeParcelable.Field(getter = "getStatus", mo19514id = 3)
    private int zzbo;
    @SafeParcelable.Field(getter = "getTransferBytes", mo19514id = 4)
    private byte[] zzbp;
    @SafeParcelable.Field(getter = "getPendingIntent", mo19514id = 5)
    private PendingIntent zzbq;
    @SafeParcelable.Field(getter = "getDeviceMetaData", mo19514id = 6)
    private DeviceMetaData zzbr;
    @SafeParcelable.VersionField(mo19520id = 1)
    private final int zzv;

    @SafeParcelable.Constructor
    zzt(@SafeParcelable.Indicator Set<Integer> set, @SafeParcelable.Param(mo19517id = 1) int i, @SafeParcelable.Param(mo19517id = 2) String str, @SafeParcelable.Param(mo19517id = 3) int i2, @SafeParcelable.Param(mo19517id = 4) byte[] bArr, @SafeParcelable.Param(mo19517id = 5) PendingIntent pendingIntent, @SafeParcelable.Param(mo19517id = 6) DeviceMetaData deviceMetaData) {
        this.zzba = set;
        this.zzv = i;
        this.zzbn = str;
        this.zzbo = i2;
