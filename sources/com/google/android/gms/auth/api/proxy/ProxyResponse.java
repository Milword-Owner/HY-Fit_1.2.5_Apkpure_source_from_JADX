...
public class ProxyResponse extends AbstractSafeParcelable {
    ...
    ProxyResponse(@SafeParcelable.Param(mo19517id = 1000) int i, @SafeParcelable.Param(mo19517id = 1) int i2, @SafeParcelable.Param(mo19517id = 2) PendingIntent pendingIntent, @SafeParcelable.Param(mo19517id = 3) int i3, @SafeParcelable.Param(mo19517id = 4) Bundle bundle, @SafeParcelable.Param(mo19517id = 5) byte[] bArr) {
        this.versionCode = i;
