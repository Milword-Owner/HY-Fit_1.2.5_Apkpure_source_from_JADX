...
public class AccountChangeEvent extends AbstractSafeParcelable {
    ...
    AccountChangeEvent(@SafeParcelable.Param(mo19517id = 1) int i, @SafeParcelable.Param(mo19517id = 2) long j, @SafeParcelable.Param(mo19517id = 3) String str, @SafeParcelable.Param(mo19517id = 4) int i2, @SafeParcelable.Param(mo19517id = 5) int i3, @SafeParcelable.Param(mo19517id = 6) String str2) {
        this.zze = i;
        this.zzf = j;
