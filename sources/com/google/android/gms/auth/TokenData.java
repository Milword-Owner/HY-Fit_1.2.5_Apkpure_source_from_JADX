...
public class TokenData extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getGrantedScopes", mo19514id = 6)
    private final List<String> zzaa;
    @SafeParcelable.Field(getter = "getScopeData", mo19514id = 7)
    private final String zzab;
    @SafeParcelable.VersionField(mo19520id = 1)
    private final int zzv;
    @SafeParcelable.Field(getter = "getToken", mo19514id = 2)
    private final String zzw;
    @SafeParcelable.Field(getter = "getExpirationTimeSecs", mo19514id = 3)
    private final Long zzx;
    @SafeParcelable.Field(getter = "isCached", mo19514id = 4)
    private final boolean zzy;
    @SafeParcelable.Field(getter = "isSnowballed", mo19514id = 5)
    ...
    TokenData(@SafeParcelable.Param(mo19517id = 1) int i, @SafeParcelable.Param(mo19517id = 2) String str, @SafeParcelable.Param(mo19517id = 3) Long l, @SafeParcelable.Param(mo19517id = 4) boolean z, @SafeParcelable.Param(mo19517id = 5) boolean z2, @SafeParcelable.Param(mo19517id = 6) List<String> list, @SafeParcelable.Param(mo19517id = 7) String str2) {
        this.zzv = i;
