...
public final class zzv extends AbstractSafeParcelable {
    ...
    public zzv(@SafeParcelable.Param(mo19517id = 1) PendingIntent pendingIntent, @SafeParcelable.Param(mo19517id = 2) @Nullable IBinder iBinder) {
        zzcn zzcn;
    ...
    public final boolean equals(@Nullable Object obj) {
        if (obj != this) {
            return (obj instanceof zzv) && Objects.equal(this.zzrk, ((zzv) obj).zzrk);
        }
        return true;
    }
