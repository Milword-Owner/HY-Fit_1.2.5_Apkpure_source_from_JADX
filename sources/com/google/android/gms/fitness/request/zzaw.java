...
public final class zzaw extends AbstractSafeParcelable {
    ...
    zzaw(@SafeParcelable.Param(mo19517id = 1) PendingIntent pendingIntent, @SafeParcelable.Param(mo19517id = 2) @Nullable IBinder iBinder) {
        zzcn zzcn;
    ...
    public zzaw(PendingIntent pendingIntent, @Nullable zzcn zzcn) {
        this.zzrk = pendingIntent;
        this.zzql = zzcn;
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        if (this != obj) {
            return (obj instanceof zzaw) && Objects.equal(this.zzrk, ((zzaw) obj).zzrk);
        }
        return true;
    }
