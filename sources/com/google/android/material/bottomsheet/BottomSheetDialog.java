...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            this.container = (FrameLayout) View.inflate(getContext(), C1722R.C1727layout.design_bottom_sheet_dialog, (ViewGroup) null);
            this.behavior = BottomSheetBehavior.from((FrameLayout) this.container.findViewById(C1722R.C1725id.design_bottom_sheet));
    ...
    private View wrapInBottomSheet(int i, @Nullable View view, @Nullable ViewGroup.LayoutParams layoutParams) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) this.container.findViewById(C1722R.C1725id.coordinator);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, coordinatorLayout, false);
        }
        FrameLayout frameLayout = (FrameLayout) this.container.findViewById(C1722R.C1725id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C1722R.C1725id.touch_outside).setOnClickListener(new View.OnClickListener() {
    ...
    private static int getThemeResId(@NonNull Context context, int i) {
        ...
        if (context.getTheme().resolveAttribute(C1722R.attr.bottomSheetDialogTheme, typedValue, true)) {
            return typedValue.resourceId;
        }
        return C1722R.C1728style.Theme_Design_Light_BottomSheetDialog;
    }
