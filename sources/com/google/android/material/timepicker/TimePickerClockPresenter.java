...
class TimePickerClockPresenter implements ClockHandView.OnRotateListener, TimePickerView.OnSelectionChange, TimePickerView.OnPeriodChangeListener, ClockHandView.OnActionUpListener, TimePickerPresenter {
    ...
    private static final String[] HOUR_CLOCK_24_VALUES = {"00", "2", PropertyType.PAGE_PROPERTRY, "6", "8", "10", "12", "14", "16", "18", "20", "22"};
    private static final String[] HOUR_CLOCK_VALUES = {"12", "1", "2", "3", PropertyType.PAGE_PROPERTRY, "5", "6", "7", "8", "9", "10", "11"};
    ...
    public void setSelection(int i, boolean z) {
        ...
        timePickerView2.setValues(strArr, z2 ? C1722R.string.material_minute_suffix : C1722R.string.material_hour_suffix);
        ...
        timePickerView3.setMinuteHourDelegate(new ClickActionDelegate(timePickerView3.getContext(), C1722R.string.material_hour_selection));
        TimePickerView timePickerView4 = this.timePickerView;
        timePickerView4.setHourClickDelegate(new ClickActionDelegate(timePickerView4.getContext(), C1722R.string.material_minute_selection));
    }
