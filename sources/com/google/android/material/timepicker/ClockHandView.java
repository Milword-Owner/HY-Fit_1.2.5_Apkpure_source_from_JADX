...
class ClockHandView extends View {
    ...
    public interface OnActionUpListener {
        void onActionUp(@FloatRange(from = 0.0d, mo652to = 360.0d) float f, boolean z);
    }

    public interface OnRotateListener {
        void onRotate(@FloatRange(from = 0.0d, mo652to = 360.0d) float f, boolean z);
    }
    ...
    public ClockHandView(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C1722R.attr.materialClockStyle);
    }
    ...
    public ClockHandView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1722R.styleable.ClockHandView, i, C1722R.C1728style.Widget_MaterialComponents_TimePicker_Clock);
        this.circleRadius = obtainStyledAttributes.getDimensionPixelSize(C1722R.styleable.ClockHandView_materialCircleRadius, 0);
        this.selectorRadius = obtainStyledAttributes.getDimensionPixelSize(C1722R.styleable.ClockHandView_selectorSize, 0);
        Resources resources = getResources();
        this.selectorStrokeWidth = resources.getDimensionPixelSize(C1722R.dimen.material_clock_hand_stroke_width);
        this.centerDotRadius = (float) resources.getDimensionPixelSize(C1722R.dimen.material_clock_hand_center_dot_radius);
        int color = obtainStyledAttributes.getColor(C1722R.styleable.ClockHandView_clockHandColor, 0);
    ...
    public void setHandRotation(@FloatRange(from = 0.0d, mo652to = 360.0d) float f) {
        setHandRotation(f, false);
    }

    public void setHandRotation(@FloatRange(from = 0.0d, mo652to = 360.0d) float f, boolean z) {
    ...
    public void setHandRotationInternal(@FloatRange(from = 0.0d, mo652to = 360.0d) float f, boolean z) {
        float f2 = f % 360.0f;
        this.originalDeg = f2;
    ...
    @FloatRange(from = 0.0d, mo652to = 360.0d)
