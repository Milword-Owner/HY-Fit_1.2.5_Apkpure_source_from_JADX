...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    static final int DEF_STYLE_RES = C1722R.C1728style.Widget_MaterialComponents_ProgressIndicator;
    ...
    protected BaseProgressIndicator(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i) {
        super(MaterialThemeOverlay.wrap(context, attributeSet, i, DEF_STYLE_RES), attributeSet, i);
        Context context2 = getContext();
        this.spec = createSpec(context2, attributeSet);
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1722R.styleable.BaseProgressIndicator, i, DEF_STYLE_RES, new int[0]);
        this.showDelay = obtainStyledAttributes.getInt(C1722R.styleable.BaseProgressIndicator_showDelay, -1);
        this.minHideDelay = Math.min(obtainStyledAttributes.getInt(C1722R.styleable.BaseProgressIndicator_minHideDelay, -1), 1000);
    ...
    public void setTrackThickness(@C0041Px int i) {
    ...
    public void setIndicatorColor(@ColorInt int... iArr) {
        if (iArr.length == 0) {
            iArr = new int[]{MaterialColors.getColor(getContext(), C1722R.attr.colorPrimary, -1)};
        }
    ...
    public void setTrackCornerRadius(@C0041Px int i) {
