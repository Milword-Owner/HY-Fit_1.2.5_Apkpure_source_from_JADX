...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C1722R.attr.autoCompleteTextViewStyle);
    }
    ...
    public MaterialAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1722R.styleable.MaterialAutoCompleteTextView, i, C1722R.C1728style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        if (obtainStyledAttributes.hasValue(C1722R.styleable.MaterialAutoCompleteTextView_android_inputType) && obtainStyledAttributes.getInt(C1722R.styleable.MaterialAutoCompleteTextView_android_inputType, 0) == 0) {
