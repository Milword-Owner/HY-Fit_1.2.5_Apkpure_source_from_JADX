...
public class LunarCalendar {
    private static final int[] DAYS_BEFORE_MONTH = {0, 31, 59, 90, 120, 151, 181, BuildConfig.VERSION_CODE, 243, 273, 304, 334, 365};
    ...
    public static final int[] solarToLunarDeprecated(int i, int i2, int i3) {
        ...
        int i4 = MIN_YEAR;
        int i5 = 0;
        int time = (int) ((new GregorianCalendar(i, i2 - 1, i3).getTime().getTime() - new GregorianCalendar(MIN_YEAR, 0, 31).getTime().getTime()) / DateUtil.DAY_MILL_SECONDS);
        int i6 = 0;
