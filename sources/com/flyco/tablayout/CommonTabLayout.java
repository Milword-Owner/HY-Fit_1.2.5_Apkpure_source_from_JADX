...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attributeSet) {
        float f;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1605R.styleable.CommonTabLayout);
        this.mIndicatorStyle = obtainStyledAttributes.getInt(C1605R.styleable.CommonTabLayout_tl_indicator_style, 0);
        this.mIndicatorColor = obtainStyledAttributes.getColor(C1605R.styleable.CommonTabLayout_tl_indicator_color, Color.parseColor(this.mIndicatorStyle == 2 ? "#4B6A87" : "#ffffff"));
        int i = C1605R.styleable.CommonTabLayout_tl_indicator_height;
        ...
        this.mIndicatorWidth = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_indicator_width, (float) dp2px(this.mIndicatorStyle == 1 ? 10.0f : -1.0f));
        this.mIndicatorCornerRadius = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_indicator_corner_radius, (float) dp2px(this.mIndicatorStyle == 2 ? -1.0f : 0.0f));
        this.mIndicatorMarginLeft = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_indicator_margin_left, (float) dp2px(0.0f));
        float f2 = 7.0f;
        this.mIndicatorMarginTop = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_indicator_margin_top, (float) dp2px(this.mIndicatorStyle == 2 ? 7.0f : 0.0f));
        this.mIndicatorMarginRight = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_indicator_margin_right, (float) dp2px(0.0f));
        int i3 = C1605R.styleable.CommonTabLayout_tl_indicator_margin_bottom;
        if (this.mIndicatorStyle != 2) {
            f2 = 0.0f;
        }
        this.mIndicatorMarginBottom = obtainStyledAttributes.getDimension(i3, (float) dp2px(f2));
        this.mIndicatorAnimEnable = obtainStyledAttributes.getBoolean(C1605R.styleable.CommonTabLayout_tl_indicator_anim_enable, true);
        this.mIndicatorBounceEnable = obtainStyledAttributes.getBoolean(C1605R.styleable.CommonTabLayout_tl_indicator_bounce_enable, true);
        this.mIndicatorAnimDuration = (long) obtainStyledAttributes.getInt(C1605R.styleable.CommonTabLayout_tl_indicator_anim_duration, -1);
        this.mIndicatorGravity = obtainStyledAttributes.getInt(C1605R.styleable.CommonTabLayout_tl_indicator_gravity, 80);
        this.mUnderlineColor = obtainStyledAttributes.getColor(C1605R.styleable.CommonTabLayout_tl_underline_color, Color.parseColor("#ffffff"));
        this.mUnderlineHeight = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_underline_height, (float) dp2px(0.0f));
        this.mUnderlineGravity = obtainStyledAttributes.getInt(C1605R.styleable.CommonTabLayout_tl_underline_gravity, 80);
        this.mDividerColor = obtainStyledAttributes.getColor(C1605R.styleable.CommonTabLayout_tl_divider_color, Color.parseColor("#ffffff"));
        this.mDividerWidth = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_divider_width, (float) dp2px(0.0f));
        this.mDividerPadding = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_divider_padding, (float) dp2px(12.0f));
        this.mTextsize = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_textsize, (float) sp2px(13.0f));
        this.mTextSelectColor = obtainStyledAttributes.getColor(C1605R.styleable.CommonTabLayout_tl_textSelectColor, Color.parseColor("#ffffff"));
        this.mTextUnselectColor = obtainStyledAttributes.getColor(C1605R.styleable.CommonTabLayout_tl_textUnselectColor, Color.parseColor("#AAffffff"));
        this.mTextBold = obtainStyledAttributes.getInt(C1605R.styleable.CommonTabLayout_tl_textBold, 0);
        this.mTextAllCaps = obtainStyledAttributes.getBoolean(C1605R.styleable.CommonTabLayout_tl_textAllCaps, false);
        this.mIconVisible = obtainStyledAttributes.getBoolean(C1605R.styleable.CommonTabLayout_tl_iconVisible, true);
        this.mIconGravity = obtainStyledAttributes.getInt(C1605R.styleable.CommonTabLayout_tl_iconGravity, 48);
        this.mIconWidth = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_iconWidth, (float) dp2px(0.0f));
        this.mIconHeight = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_iconHeight, (float) dp2px(0.0f));
        this.mIconMargin = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_iconMargin, (float) dp2px(2.5f));
        this.mTabSpaceEqual = obtainStyledAttributes.getBoolean(C1605R.styleable.CommonTabLayout_tl_tab_space_equal, true);
        this.mTabWidth = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_tab_width, (float) dp2px(-1.0f));
        this.mTabPadding = obtainStyledAttributes.getDimension(C1605R.styleable.CommonTabLayout_tl_tab_padding, (float) ((this.mTabSpaceEqual || this.mTabWidth > 0.0f) ? dp2px(0.0f) : dp2px(10.0f)));
        obtainStyledAttributes.recycle();
    }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < this.mTabCount; i++) {
            ...
            if (i2 == 3) {
                view = View.inflate(this.mContext, C1605R.C1607layout.layout_tab_left, (ViewGroup) null);
            } else if (i2 == 5) {
                view = View.inflate(this.mContext, C1605R.C1607layout.layout_tab_right, (ViewGroup) null);
            } else if (i2 == 80) {
                view = View.inflate(this.mContext, C1605R.C1607layout.layout_tab_bottom, (ViewGroup) null);
            } else {
                view = View.inflate(this.mContext, C1605R.C1607layout.layout_tab_top, (ViewGroup) null);
            }
    ...
    private void addTab(int i, View view) {
        ((TextView) view.findViewById(C1605R.C1606id.tv_tab_title)).setText(this.mTabEntitys.get(i).getTabTitle());
        ((ImageView) view.findViewById(C1605R.C1606id.iv_tab_icon)).setImageResource(this.mTabEntitys.get(i).getTabUnselectedIcon());
    ...
    private void updateTabStyles() {
        ...
        while (i < this.mTabCount) {
            ...
            TextView textView = (TextView) childAt.findViewById(C1605R.C1606id.tv_tab_title);
            ...
            ImageView imageView = (ImageView) childAt.findViewById(C1605R.C1606id.iv_tab_icon);
    ...
    private void calcIndicatorRect() {
        ...
        if (this.mIndicatorWidth >= 0.0f) {
            float left = ((float) childAt.getLeft()) + ((((float) childAt.getWidth()) - this.mIndicatorWidth) / 2.0f);
            Rect rect2 = this.mIndicatorRect;
            rect2.left = (int) left;
            rect2.right = (int) (((float) rect2.left) + this.mIndicatorWidth);
        }
    }
    ...
    public ImageView getIconView(int i) {
        return (ImageView) this.mTabsContainer.getChildAt(i).findViewById(C1605R.C1606id.iv_tab_icon);
    }

    public TextView getTitleView(int i) {
        return (TextView) this.mTabsContainer.getChildAt(i).findViewById(C1605R.C1606id.tv_tab_title);
    }
    ...
    public void showMsg(int i, int i2) {
        ...
        MsgView msgView = (MsgView) this.mTabsContainer.getChildAt(i).findViewById(C1605R.C1606id.rtv_msg_tip);
        if (msgView != null) {
    ...
    public void setMsgMargin(int i, float f, float f2) {
        ...
        View childAt = this.mTabsContainer.getChildAt(i);
        MsgView msgView = (MsgView) childAt.findViewById(C1605R.C1606id.rtv_msg_tip);
        if (msgView != null) {
            this.mTextPaint.setTextSize(this.mTextsize);
            this.mTextPaint.measureText(((TextView) childAt.findViewById(C1605R.C1606id.tv_tab_title)).getText().toString());
    ...
    public MsgView getMsgView(int i) {
        ...
        return (MsgView) this.mTabsContainer.getChildAt(i).findViewById(C1605R.C1606id.rtv_msg_tip);
    }
