package com.zhihu.matisse.p035ui;
...
import com.zhihu.matisse.internal.p034ui.AlbumPreviewActivity;
import com.zhihu.matisse.internal.p034ui.BasePreviewActivity;
import com.zhihu.matisse.internal.p034ui.MediaSelectionFragment;
import com.zhihu.matisse.internal.p034ui.SelectedPreviewActivity;
import com.zhihu.matisse.internal.p034ui.adapter.AlbumMediaAdapter;
import com.zhihu.matisse.internal.p034ui.adapter.AlbumsAdapter;
import com.zhihu.matisse.internal.p034ui.widget.AlbumsSpinner;
...
public class MatisseActivity extends AppCompatActivity implements AlbumCollection.AlbumCallbacks, AdapterView.OnItemSelectedListener, MediaSelectionFragment.SelectionProvider, View.OnClickListener, AlbumMediaAdapter.CheckStateListener, AlbumMediaAdapter.OnMediaClickListener, AlbumMediaAdapter.OnPhotoCapture {
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        setContentView(C2570R.C2575layout.activity_matisse);
        ...
        Toolbar toolbar = (Toolbar) findViewById(C2570R.C2573id.toolbar);
        setSupportActionBar(toolbar);
        ActionBar supportActionBar = getSupportActionBar();
        supportActionBar.setDisplayShowTitleEnabled(false);
        supportActionBar.setDisplayHomeAsUpEnabled(true);
        Drawable navigationIcon = toolbar.getNavigationIcon();
        TypedArray obtainStyledAttributes = getTheme().obtainStyledAttributes(new int[]{C2570R.attr.album_element_color});
        int color = obtainStyledAttributes.getColor(0, 0);
        obtainStyledAttributes.recycle();
        navigationIcon.setColorFilter(color, PorterDuff.Mode.SRC_IN);
        this.mButtonPreview = (TextView) findViewById(C2570R.C2573id.button_preview);
        this.mButtonApply = (TextView) findViewById(C2570R.C2573id.button_apply);
        this.mButtonPreview.setOnClickListener(this);
        this.mButtonApply.setOnClickListener(this);
        this.mContainer = findViewById(C2570R.C2573id.container);
        this.mEmptyView = findViewById(C2570R.C2573id.empty_view);
        ...
        this.mAlbumsSpinner.setSelectedTextView((TextView) findViewById(C2570R.C2573id.selected_album));
        this.mAlbumsSpinner.setPopupAnchorView(findViewById(C2570R.C2573id.toolbar));
    ...
    private void updateBottomToolbar() {
        ...
        if (count == 0) {
            ...
            this.mButtonApply.setText(getString(C2570R.string.button_apply_default));
    ...
    public void onClick(View view) {
        if (view.getId() == C2570R.C2573id.button_preview) {
            ...
            setResult(-1, intent2);
            finish();
        } else if (view.getId() == C2570R.C2573id.originalLayout) {
            int countOverMaxSize = countOverMaxSize();
            if (countOverMaxSize > 0) {
                IncapableDialog.newInstance("", getString(C2570R.string.error_over_original_count, new Object[]{Integer.valueOf(countOverMaxSize), Integer.valueOf(this.mSpec.originalMaxSize)})).show(getSupportFragmentManager(), IncapableDialog.class.getName());
                return;
            }
    ...
    public void onAlbumSelected(Album album) {
        if (!album.isAll() || !album.isEmpty()) {
            ...
            getSupportFragmentManager().beginTransaction().replace(C2570R.C2573id.container, MediaSelectionFragment.newInstance(album), MediaSelectionFragment.class.getSimpleName()).commitAllowingStateLoss();
            return;
        }
