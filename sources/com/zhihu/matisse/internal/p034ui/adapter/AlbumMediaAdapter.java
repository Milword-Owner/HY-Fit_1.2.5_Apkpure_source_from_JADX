...
import com.zhihu.matisse.internal.p034ui.widget.MediaGrid;
...
public class AlbumMediaAdapter extends RecyclerViewCursorAdapter<RecyclerView.ViewHolder> implements MediaGrid.OnMediaGridClickListener {
    ...
    public AlbumMediaAdapter(Context context, SelectedItemCollection selectedItemCollection, RecyclerView recyclerView) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(new int[]{C2570R.attr.item_placeholder});
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (i == 1) {
            CaptureViewHolder captureViewHolder = new CaptureViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C2570R.C2575layout.photo_capture_item, viewGroup, false));
            ...
            return new MediaViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C2570R.C2575layout.media_grid_item, viewGroup, false));
        } else {
            return null;
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, Cursor cursor) {
        ...
        if (viewHolder instanceof CaptureViewHolder) {
            ...
            TypedArray obtainStyledAttributes = viewHolder.itemView.getContext().getTheme().obtainStyledAttributes(new int[]{C2570R.attr.capture_textColor});
    ...
    private int getImageResize(Context context) {
        if (this.mImageResize == 0) {
            ...
            this.mImageResize = (context.getResources().getDisplayMetrics().widthPixels - (context.getResources().getDimensionPixelSize(C2570R.dimen.media_grid_spacing) * (spanCount - 1))) / spanCount;
    ...
    private static class CaptureViewHolder extends RecyclerView.ViewHolder {
        ...
        CaptureViewHolder(View view) {
            super(view);
            this.mHint = (TextView) view.findViewById(C2570R.C2573id.hint);
        }
    }
}
