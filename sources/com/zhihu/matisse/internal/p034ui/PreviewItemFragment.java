...
import p037it.sephiroth.android.library.imagezoom.ImageViewTouch;
import p037it.sephiroth.android.library.imagezoom.ImageViewTouchBase;
...
public class PreviewItemFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return layoutInflater.inflate(C2570R.C2575layout.fragment_preview_item, viewGroup, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle bundle) {
        ...
        if (item != null) {
            View findViewById = view.findViewById(C2570R.C2573id.video_play_button);
            if (item.isVideo()) {
                ...
                findViewById.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        ...
                        try {
                            ...
                            Toast.makeText(PreviewItemFragment.this.getContext(), C2570R.string.error_no_video_activity, 0).show();
                        }
                    }
                });
            } else {
            ...
            ImageViewTouch imageViewTouch = (ImageViewTouch) view.findViewById(C2570R.C2573id.image_view);
    ...
    public void resetView() {
        if (getView() != null) {
            ((ImageViewTouch) getView().findViewById(C2570R.C2573id.image_view)).resetMatrix();
        }
    }
