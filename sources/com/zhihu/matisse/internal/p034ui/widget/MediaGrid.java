...
public class MediaGrid extends SquareFrameLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(C2570R.C2575layout.media_grid_content, this, true);
        this.mThumbnail = (ImageView) findViewById(C2570R.C2573id.media_thumbnail);
        this.mCheckView = (CheckView) findViewById(C2570R.C2573id.check_view);
        this.mGifTag = (ImageView) findViewById(C2570R.C2573id.gif);
        this.mVideoDuration = (TextView) findViewById(C2570R.C2573id.video_duration);
