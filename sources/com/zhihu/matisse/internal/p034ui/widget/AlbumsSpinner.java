...
public class AlbumsSpinner {
    ...
    public AlbumsSpinner(@NonNull Context context) {
        this.mListPopupWindow = new ListPopupWindow(context, (AttributeSet) null, C2570R.attr.listPopupWindowStyle);
    ...
    public void setSelectedTextView(TextView textView) {
        ...
        TypedArray obtainStyledAttributes = this.mSelected.getContext().getTheme().obtainStyledAttributes(new int[]{C2570R.attr.album_element_color});
        ...
        this.mSelected.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                int i;
                int dimensionPixelSize = view.getResources().getDimensionPixelSize(C2570R.dimen.album_item_height);
