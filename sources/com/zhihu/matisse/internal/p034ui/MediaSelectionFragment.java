...
import com.zhihu.matisse.internal.p034ui.widget.MediaGridInset;
...
public class MediaSelectionFragment extends Fragment implements AlbumMediaCollection.AlbumMediaCallbacks, AlbumMediaAdapter.CheckStateListener, AlbumMediaAdapter.OnMediaClickListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        return layoutInflater.inflate(C2570R.C2575layout.fragment_media_selection, viewGroup, false);
    }

    public void onViewCreated(View view, @Nullable Bundle bundle) {
        super.onViewCreated(view, bundle);
        this.mRecyclerView = (RecyclerView) view.findViewById(C2570R.C2573id.recyclerview);
    }
    ...
    public void onActivityCreated(@Nullable Bundle bundle) {
        ...
        this.mRecyclerView.addItemDecoration(new MediaGridInset(i, getResources().getDimensionPixelSize(C2570R.dimen.media_grid_spacing), false));
