...
public class SelectedItemCollection {
    ...
    public IncapableCause isAcceptable(Item item) {
        ...
        if (maxSelectableReached()) {
            ...
            try {
                str = this.mContext.getResources().getQuantityString(C2570R.plurals.error_over_count, currentMaxSelectable, new Object[]{Integer.valueOf(currentMaxSelectable)});
            } catch (Resources.NotFoundException unused) {
                str = this.mContext.getString(C2570R.string.error_over_count, new Object[]{Integer.valueOf(currentMaxSelectable)});
            } catch (NoClassDefFoundError unused2) {
                str = this.mContext.getString(C2570R.string.error_over_count, new Object[]{Integer.valueOf(currentMaxSelectable)});
            }
            return new IncapableCause(str);
        } else if (typeConflict(item)) {
            return new IncapableCause(this.mContext.getString(C2570R.string.error_type_conflict));
        } else {
