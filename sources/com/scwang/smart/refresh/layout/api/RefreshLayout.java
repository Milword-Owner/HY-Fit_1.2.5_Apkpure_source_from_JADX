...
public interface RefreshLayout {
    ...
    RefreshLayout setDragRate(@FloatRange(from = 0.0d, mo652to = 1.0d) float f);
    ...
    RefreshLayout setFooterMaxDragRate(@FloatRange(from = 1.0d, mo652to = 10.0d) float f);

    RefreshLayout setFooterTranslationViewId(@IdRes int i);

    RefreshLayout setFooterTriggerRate(@FloatRange(from = 0.0d, mo652to = 1.0d) float f);
    ...
    RefreshLayout setHeaderMaxDragRate(@FloatRange(from = 1.0d, mo652to = 10.0d) float f);

    RefreshLayout setHeaderTranslationViewId(@IdRes int i);

    RefreshLayout setHeaderTriggerRate(@FloatRange(from = 0.0d, mo652to = 1.0d) float f);
