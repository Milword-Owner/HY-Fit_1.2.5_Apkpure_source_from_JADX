...
public abstract class ClassicsAbstract<T extends ClassicsAbstract> extends SimpleComponent implements RefreshComponent {
    public static final int ID_IMAGE_ARROW = C2540R.C2541id.srl_classics_arrow;
    public static final int ID_IMAGE_PROGRESS = C2540R.C2541id.srl_classics_progress;
    public static final int ID_TEXT_TITLE = C2540R.C2541id.srl_classics_title;
    protected PaintDrawable mArrowDrawable;
    protected ImageView mArrowView;
    protected int mBackgroundColor;
    protected int mFinishDuration = StatusCodes.INTERNAL_ERROR;
