...
public final class BrightnessUtils {
    ...
    public static boolean setBrightness(@IntRange(from = 0, mo670to = 255) int i) {
    ...
    public static void setWindowBrightness(@NonNull Window window, @IntRange(from = 0, mo670to = 255) int i) {
        if (window != null) {
