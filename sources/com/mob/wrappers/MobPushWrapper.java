            ...
            try {
                MobPush.getRegistrationId(new MobPushCallback<String>() {
                    public void onCallback(String str) {
                        MobPushCallbackWrapper mobPushCallbackWrapper = mobPushCallbackWrapper;
        ...
        if (mobPushReceiverWrapper != null && isAvailable()) {
            ...
            try {
                ...
                if (mobPushReceiver == null) {
                    C24954 r0 = new MobPushReceiver() {
                        public void onCustomMessageReceive(Context context, MobPushCustomMessage mobPushCustomMessage) {
                            mobPushReceiverWrapper.onCustomMessageReceive(context, mobPushCustomMessage != null ? new MobPushCustomMessageWrapper(mobPushCustomMessage.getContent(), mobPushCustomMessage.getExtrasMap(), mobPushCustomMessage.getMessageId(), mobPushCustomMessage.getTimestamp()) : null);
                        }

                        public void onNotifyMessageReceive(Context context, MobPushNotifyMessage mobPushNotifyMessage) {
                            Context context2 = context;
                            mobPushReceiverWrapper.onNotifyMessageReceive(context, mobPushNotifyMessage != null ? new MobPushNotifyMessageWrapper(mobPushNotifyMessage.getStyle(), mobPushNotifyMessage.getTitle(), mobPushNotifyMessage.getContent(), mobPushNotifyMessage.getStyleContent(), mobPushNotifyMessage.getInboxStyleContent(), mobPushNotifyMessage.getExtrasMap(), mobPushNotifyMessage.getMessageId(), mobPushNotifyMessage.getTimestamp(), mobPushNotifyMessage.isVoice(), mobPushNotifyMessage.isShake(), mobPushNotifyMessage.isLight()) : null);
                        }

                        public void onNotifyMessageOpenedReceive(Context context, MobPushNotifyMessage mobPushNotifyMessage) {
                            Context context2 = context;
                            mobPushReceiverWrapper.onNotifyMessageOpenedReceive(context, mobPushNotifyMessage != null ? new MobPushNotifyMessageWrapper(mobPushNotifyMessage.getStyle(), mobPushNotifyMessage.getTitle(), mobPushNotifyMessage.getContent(), mobPushNotifyMessage.getStyleContent(), mobPushNotifyMessage.getInboxStyleContent(), mobPushNotifyMessage.getExtrasMap(), mobPushNotifyMessage.getMessageId(), mobPushNotifyMessage.getTimestamp(), mobPushNotifyMessage.isVoice(), mobPushNotifyMessage.isShake(), mobPushNotifyMessage.isLight()) : null);
                        }
