    ...
    public PullToRequestListAdapter(PullToRequestView pullToRequestView) {
        ...
        this.listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView absListView, int i) {
                boolean unused = PullToRequestListAdapter.this.fling = i == 2;
                if (i != 0) {
                    return;
                }
            ...
            public void onScroll(AbsListView absListView, int i, int i2, int i3) {
                ...
                boolean unused = PullToRequestListAdapter.this.pullUpReady = i + i2 == i3 && childAt != null && childAt.getBottom() <= absListView.getBottom();
