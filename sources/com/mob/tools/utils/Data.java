...
public class Data {
    ...
    public static byte[] AES128Encode(String str, String str2) throws Throwable {
        ...
        Cipher cipher = getCipher("AES" + "/EC" + "B/PKCS7P" + "adding", "BC");
    ...
    public static byte[] AES128Decode(byte[] bArr, byte[] bArr2) throws Throwable {
        ...
        Cipher cipher = getCipher("AES" + "/EC" + "B/NoP" + "adding", "BC");
    ...
    public static String base62(long j) {
        ...
        while (j > 0) {
            j /= 62;
            str = CHAT_SET.charAt((int) (j % 62)) + str;
        }
        return str;
    }
    ...
    public static byte[] rawMD5(byte[] bArr, int i, int i2) {
        ...
        try {
            ...
            byte[] rawMD5 = rawMD5((InputStream) byteArrayInputStream);
    ...
    public static String CRC32(byte[] bArr) throws Throwable {
        ...
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 56))) & UByte.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 48))) & UByte.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 40))) & UByte.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 32))) & UByte.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 24))) & UByte.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 16))) & UByte.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) (value >>> 8))) & UByte.MAX_VALUE)}));
        sb.append(String.format("%02x", new Object[]{Integer.valueOf(((byte) ((int) value)) & UByte.MAX_VALUE)}));
        while (sb.charAt(0) == '0') {
    ...
    public static byte[] rawRSAEncode(byte[] bArr, byte[] bArr2, int i) throws Throwable {
        ...
        instance.init(1, (RSAPublicKey) KeyFactory.getInstance("RSA").generatePublic(x509EncodedKeySpec));
    ...
    public static byte[] rawRSADecode(byte[] bArr, byte[] bArr2, int i) throws Throwable {
        Cipher instance = Cipher.getInstance("RSA/None/PKCS1Padding");
        instance.init(2, (RSAPrivateKey) KeyFactory.getInstance("RSA").generatePrivate(new PKCS8EncodedKeySpec(bArr2)));
        int i2 = i / 8;
