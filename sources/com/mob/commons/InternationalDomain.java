...
public enum InternationalDomain implements EverythingKeeper {
    ...
    GD("gd", "Grenada"),
    GE(UserDataStore.GENDER, "Georgia"),
    GF("gf", "French Guiana"),
    GH("gh", "Ghana"),
    GI("gi", "Gibraltar"),
    GM("gm", "Gambia"),
    ...
    NL("nl", "Netherlands"),
    NO("no", "Norway"),
    NP(Config.EVENT_NEXT_PAGENAME, "Nepal"),
    NR("nr", "Nauru"),
    NZ("nz", "New Zealand"),
    OM("om", "Oman"),
    PA("pa", "Panama"),
    ...
    /* renamed from: sp */
    private static SharePrefrenceHelper f1915sp;
    ...
    public static synchronized InternationalDomain readFromBuffer() {
        synchronized (InternationalDomain.class) {
            if (f1915sp == null) {
                f1915sp = new SharePrefrenceHelper(MobSDK.getContext());
                f1915sp.open("domain", 1);
            }
            String string = f1915sp.getString("domain");
            ...
            InternationalDomain domainOf = domainOf(string);
            return domainOf;
        }
    }
    ...
    public static synchronized void saveBuffer(InternationalDomain internationalDomain) {
        synchronized (InternationalDomain.class) {
            ...
            if (internationalDomain == null) {
                f1915sp.putString("domain", "null");
            } else {
                f1915sp.putString("domain", internationalDomain.domain);
            }
        }
    }
}
