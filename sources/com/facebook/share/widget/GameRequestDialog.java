...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, Result> {
    ...
    public static final class Result {
        ...
        private Result(Bundle bundle) {
            ...
            this.f1539to = new ArrayList();
            while (true) {
                if (bundle.containsKey(String.format(ShareConstants.WEB_DIALOG_RESULT_PARAM_TO_ARRAY_MEMBER, new Object[]{Integer.valueOf(this.f1539to.size())}))) {
                    List<String> list = this.f1539to;
