...
public class LikeView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet != null && getContext() != null && (obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C1388R.styleable.com_facebook_like_view)) != null) {
            this.objectId = Utility.coerceValueIfNullOrEmpty(obtainStyledAttributes.getString(C1388R.styleable.com_facebook_like_view_com_facebook_object_id), (String) null);
            this.objectType = ObjectType.fromInt(obtainStyledAttributes.getInt(C1388R.styleable.com_facebook_like_view_com_facebook_object_type, ObjectType.DEFAULT.getValue()));
            this.likeViewStyle = Style.fromInt(obtainStyledAttributes.getInt(C1388R.styleable.com_facebook_like_view_com_facebook_style, Style.DEFAULT.getValue()));
            if (this.likeViewStyle != null) {
                this.auxiliaryViewPosition = AuxiliaryViewPosition.fromInt(obtainStyledAttributes.getInt(C1388R.styleable.com_facebook_like_view_com_facebook_auxiliary_view_position, AuxiliaryViewPosition.DEFAULT.getValue()));
                if (this.auxiliaryViewPosition != null) {
                    this.horizontalAlignment = HorizontalAlignment.fromInt(obtainStyledAttributes.getInt(C1388R.styleable.com_facebook_like_view_com_facebook_horizontal_alignment, HorizontalAlignment.DEFAULT.getValue()));
                    if (this.horizontalAlignment != null) {
                        this.foregroundColor = obtainStyledAttributes.getColor(C1388R.styleable.com_facebook_like_view_com_facebook_foreground_color, -1);
    ...
    private void initialize(Context context) {
        this.edgePadding = getResources().getDimensionPixelSize(C1388R.dimen.com_facebook_likeview_edge_padding);
        this.internalPadding = getResources().getDimensionPixelSize(C1388R.dimen.com_facebook_likeview_internal_padding);
        if (this.foregroundColor == -1) {
            this.foregroundColor = getResources().getColor(C1388R.C1389color.com_facebook_likeview_text_color);
        }
    ...
    private void initializeSocialSentenceView(Context context) {
        ...
        this.socialSentenceView.setTextSize(0, getResources().getDimension(C1388R.dimen.com_facebook_likeview_text_size));
    ...
    private void updateLayout() {
        ...
        int i3 = C15962.f1540x30689ac[this.auxiliaryViewPosition.ordinal()];
        if (i3 == 1) {
    ...
    static /* synthetic */ class C15962 {
        ...
        static final /* synthetic */ int[] f1540x30689ac = new int[AuxiliaryViewPosition.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f1540x30689ac = r0
                int[] r0 = f1540x30689ac     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f1540x30689ac     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f1540x30689ac     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.widget.LikeView.C15962.<clinit>():void");
        }
    }

    private void updateBoxCountCaretPosition() {
        int i = C15962.f1540x30689ac[this.auxiliaryViewPosition.ordinal()];
        if (i == 1) {
