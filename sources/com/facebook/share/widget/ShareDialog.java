...
public final class ShareDialog extends FacebookDialogBase<ShareContent, Sharer.Result> implements Sharer {
    ...
    public List<FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler> getOrderedModeHandlers() {
        ...
        arrayList.add(new NativeHandler(this, (C16001) null));
        arrayList.add(new FeedHandler(this, (C16001) null));
        arrayList.add(new WebShareHandler(this, (C16001) null));
        arrayList.add(new CameraEffectHandler(this, (C16001) null));
        arrayList.add(new ShareStoryHandler(this, (C16001) null));
        return arrayList;
    }
    ...
    private class NativeHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ NativeHandler(ShareDialog shareDialog, C16001 r2) {
            this();
        }
    ...
    private class WebShareHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ WebShareHandler(ShareDialog shareDialog, C16001 r2) {
            this();
        }
    ...
    private class FeedHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ FeedHandler(ShareDialog shareDialog, C16001 r2) {
            this();
        }
    ...
    private class CameraEffectHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ CameraEffectHandler(ShareDialog shareDialog, C16001 r2) {
            this();
        }
    ...
    private class ShareStoryHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ ShareStoryHandler(ShareDialog shareDialog, C16001 r2) {
            this();
        }
    ...
    public void logDialogShare(Context context, ShareContent shareContent, Mode mode) {
        ...
        int i = C16001.$SwitchMap$com$facebook$share$widget$ShareDialog$Mode[mode.ordinal()];
        String str = "unknown";
    ...
    static /* synthetic */ class C16001 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.widget.ShareDialog.C16001.<clinit>():void");
        }
    }
}
