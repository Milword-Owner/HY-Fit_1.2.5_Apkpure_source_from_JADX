...
public class LikeBoxCountView extends FrameLayout {
    ...
    public void setCaretPosition(LikeBoxCountViewCaretPosition likeBoxCountViewCaretPosition) {
        ...
        int i = C15371.f1534x5851190f[likeBoxCountViewCaretPosition.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C15371 {
        ...
        static final /* synthetic */ int[] f1534x5851190f = new int[LikeBoxCountViewCaretPosition.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f1534x5851190f = r0
                int[] r0 = f1534x5851190f     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f1534x5851190f     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f1534x5851190f     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = f1534x5851190f     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.internal.LikeBoxCountView.C15371.<clinit>():void");
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        int i = C15371.f1534x5851190f[this.caretPosition.ordinal()];
        if (i == 1) {
    ...
    private void initialize(Context context) {
        ...
        this.caretHeight = getResources().getDimension(C1388R.dimen.com_facebook_likeboxcountview_caret_height);
        this.caretWidth = getResources().getDimension(C1388R.dimen.com_facebook_likeboxcountview_caret_width);
        this.borderRadius = getResources().getDimension(C1388R.dimen.com_facebook_likeboxcountview_border_radius);
        this.borderPaint = new Paint();
        this.borderPaint.setColor(getResources().getColor(C1388R.C1389color.com_facebook_likeboxcountview_border_color));
        this.borderPaint.setStrokeWidth(getResources().getDimension(C1388R.dimen.com_facebook_likeboxcountview_border_width));
    ...
    private void initializeLikeCountLabel(Context context) {
        ...
        this.likeCountLabel.setTextSize(0, getResources().getDimension(C1388R.dimen.com_facebook_likeboxcountview_text_size));
        this.likeCountLabel.setTextColor(getResources().getColor(C1388R.C1389color.com_facebook_likeboxcountview_text_color));
        this.textPadding = getResources().getDimensionPixelSize(C1388R.dimen.com_facebook_likeboxcountview_text_padding);
        this.additionalTextPadding = getResources().getDimensionPixelSize(C1388R.dimen.com_facebook_likeboxcountview_caret_height);
    }
