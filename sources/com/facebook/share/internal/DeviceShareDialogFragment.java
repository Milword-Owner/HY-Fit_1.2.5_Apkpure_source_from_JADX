...
public class DeviceShareDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        View inflate = getActivity().getLayoutInflater().inflate(C1388R.C1392layout.com_facebook_device_auth_dialog_fragment, (ViewGroup) null);
        this.progressBar = (ProgressBar) inflate.findViewById(C1388R.C1391id.progress_bar);
        ...
        ((TextView) inflate.findViewById(C1388R.C1391id.com_facebook_device_auth_instructions)).setText(Html.fromHtml(getString(C1388R.string.com_facebook_device_auth_instructions)));
