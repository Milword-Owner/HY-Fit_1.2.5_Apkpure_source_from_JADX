...
public class MessengerShareContentUtility {
    ...
    private static String getWebviewHeightRatioString(ShareMessengerURLActionButton.WebviewHeightRatio webviewHeightRatio) {
        ...
        int i = C15421.f1537x92e77847[webviewHeightRatio.ordinal()];
        if (i != 1) {
    ...
    private static String getImageRatioString(ShareMessengerGenericTemplateContent.ImageAspectRatio imageAspectRatio) {
        return (imageAspectRatio != null && C15421.f1535xb7309c05[imageAspectRatio.ordinal()] == 1) ? IMAGE_RATIO_SQUARE : IMAGE_RATIO_HORIZONTAL;
    }
    ...
    static /* synthetic */ class C15421 {
        ...
        static final /* synthetic */ int[] f1535xb7309c05 = new int[ShareMessengerGenericTemplateContent.ImageAspectRatio.values().length];

        /* renamed from: $SwitchMap$com$facebook$share$model$ShareMessengerMediaTemplateContent$MediaType */
        static final /* synthetic */ int[] f1536x2a75e664 = new int[ShareMessengerMediaTemplateContent.MediaType.values().length];

        /* renamed from: $SwitchMap$com$facebook$share$model$ShareMessengerURLActionButton$WebviewHeightRatio */
        static final /* synthetic */ int[] f1537x92e77847 = new int[ShareMessengerURLActionButton.WebviewHeightRatio.values().length];
        ...
        static {
            /*
                ...
                f1536x2a75e664 = r0
                r0 = 1
                int[] r1 = f1536x2a75e664     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                ...
                int[] r1 = new int[r1]
                f1535xb7309c05 = r1
                int[] r1 = f1535xb7309c05     // Catch:{ NoSuchFieldError -> 0x0027 }
            ...
            L_0x0027:
                ...
                int[] r1 = new int[r1]
                f1537x92e77847 = r1
                int[] r1 = f1537x92e77847     // Catch:{ NoSuchFieldError -> 0x003a }
            ...
            L_0x003a:
                int[] r0 = f1537x92e77847     // Catch:{ NoSuchFieldError -> 0x0045 }
            ...
            L_0x0045:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.internal.MessengerShareContentUtility.C15421.<clinit>():void");
        }
    }

    private static String getMediaType(ShareMessengerMediaTemplateContent.MediaType mediaType) {
        return (mediaType != null && C15421.f1536x2a75e664[mediaType.ordinal()] == 1) ? "video" : MEDIA_IMAGE;
    }
