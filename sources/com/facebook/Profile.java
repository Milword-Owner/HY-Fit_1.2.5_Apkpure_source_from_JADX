...
public final class Profile implements Parcelable {
    ...
    public Uri getProfilePictureUri(int i, int i2) {
        return ImageRequest.getProfilePictureUri(this.f1528id, i, i2, AccessToken.isCurrentAccessTokenActive() ? AccessToken.getCurrentAccessToken().getToken() : "");
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.f1528id.equals(profile.f1528id) || this.firstName != null) {
    ...
    public int hashCode() {
        int hashCode = 527 + this.f1528id.hashCode();
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            jSONObject.put("id", this.f1528id);
    ...
    Profile(JSONObject jSONObject) {
        Uri uri = null;
        this.f1528id = jSONObject.optString("id", (String) null);
