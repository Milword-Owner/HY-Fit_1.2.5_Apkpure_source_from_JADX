...
final class FeatureExtractor {
    ...
    static void initialize(File file) {
        try {
            ...
            languageInfo.put(ViewHierarchyConstants.JAPANESE, PropertyType.PAGE_PROPERTRY);
            ...
            eventInfo.put(ViewHierarchyConstants.INITIATE_CHECKOUT, PropertyType.PAGE_PROPERTRY);
            ...
            textTypeInfo.put(ViewHierarchyConstants.BUTTON_ID, PropertyType.PAGE_PROPERTRY);
            initialized = true;
    ...
    private static float[] parseFeatures(JSONObject jSONObject) {
        ...
        if (matchIndicators(new String[]{"$", "amount", "price", Config.EXCEPTION_MEMORY_TOTAL}, strArr)) {
