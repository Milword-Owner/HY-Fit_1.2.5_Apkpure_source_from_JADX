...
public class ProfilePictureView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C1477R.styleable.com_facebook_profile_picture_view);
        setPresetSize(obtainStyledAttributes.getInt(C1477R.styleable.com_facebook_profile_picture_view_com_facebook_preset_size, -1));
        this.isCropped = obtainStyledAttributes.getBoolean(C1477R.styleable.com_facebook_profile_picture_view_com_facebook_is_cropped, true);
    ...
    private void setBlankProfilePicture() {
        ...
        if (this.customizedDefaultProfilePicture == null) {
            setImageBitmap(BitmapFactory.decodeResource(getResources(), isCropped() ? C1477R.C1479drawable.com_facebook_profile_picture_blank_square : C1477R.C1479drawable.com_facebook_profile_picture_blank_portrait));
            return;
        }
    ...
    private int getPresetSizeInPixels(boolean z) {
        ...
        if (i2 == -4) {
            i = C1477R.dimen.com_facebook_profilepictureview_preset_size_large;
        } else if (i2 == -3) {
            i = C1477R.dimen.com_facebook_profilepictureview_preset_size_normal;
        } else if (i2 == -2) {
            i = C1477R.dimen.com_facebook_profilepictureview_preset_size_small;
        } else if (i2 != -1 || !z) {
            return 0;
        } else {
            i = C1477R.dimen.com_facebook_profilepictureview_preset_size_normal;
