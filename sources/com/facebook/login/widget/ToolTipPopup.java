...
public class ToolTipPopup {
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            ((TextView) this.mPopupContent.findViewById(C1477R.C1480id.com_facebook_tooltip_bubble_view_text_body)).setText(this.mText);
            if (this.mStyle == Style.BLUE) {
                this.mPopupContent.bodyFrame.setBackgroundResource(C1477R.C1479drawable.com_facebook_tooltip_blue_background);
                this.mPopupContent.bottomArrow.setImageResource(C1477R.C1479drawable.com_facebook_tooltip_blue_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C1477R.C1479drawable.com_facebook_tooltip_blue_topnub);
                this.mPopupContent.xOut.setImageResource(C1477R.C1479drawable.com_facebook_tooltip_blue_xout);
            } else {
                this.mPopupContent.bodyFrame.setBackgroundResource(C1477R.C1479drawable.com_facebook_tooltip_black_background);
                this.mPopupContent.bottomArrow.setImageResource(C1477R.C1479drawable.com_facebook_tooltip_black_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C1477R.C1479drawable.com_facebook_tooltip_black_topnub);
                this.mPopupContent.xOut.setImageResource(C1477R.C1479drawable.com_facebook_tooltip_black_xout);
            }
    ...
    private class PopupContentView extends FrameLayout {
        ...
        private void init() {
            LayoutInflater.from(getContext()).inflate(C1477R.C1481layout.com_facebook_tooltip_bubble, this);
            this.topArrow = (ImageView) findViewById(C1477R.C1480id.com_facebook_tooltip_bubble_view_top_pointer);
            this.bottomArrow = (ImageView) findViewById(C1477R.C1480id.com_facebook_tooltip_bubble_view_bottom_pointer);
            this.bodyFrame = findViewById(C1477R.C1480id.com_facebook_body_frame);
            this.xOut = (ImageView) findViewById(C1477R.C1480id.com_facebook_button_xout);
        }
