...
import com.facebook.login.C1477R;
...
public class LoginButton extends FacebookButtonBase {
    ...
    static /* synthetic */ class C14893 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.login.widget.LoginButton.C14893.<clinit>():void");
        }
    }

    private void checkToolTipSettings() {
        int i = C14893.$SwitchMap$com$facebook$login$widget$LoginButton$ToolTipMode[this.toolTipMode.ordinal()];
        if (i == 1) {
            ...
            displayToolTip(getResources().getString(C1477R.string.com_facebook_tooltip_default));
        }
    }
    ...
    public void configureButton(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (isInEditMode()) {
            setBackgroundColor(getResources().getColor(C1388R.C1389color.com_facebook_blue));
    ...
    public int getDefaultStyleResource() {
        return C1477R.C1482style.com_facebook_loginview_default_style;
    }

    private void parseLoginButtonAttributes(Context context, AttributeSet attributeSet, int i, int i2) {
        this.toolTipMode = ToolTipMode.DEFAULT;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C1477R.styleable.com_facebook_login_view, i, i2);
        try {
            this.confirmLogout = obtainStyledAttributes.getBoolean(C1477R.styleable.com_facebook_login_view_com_facebook_confirm_logout, true);
            this.loginText = obtainStyledAttributes.getString(C1477R.styleable.com_facebook_login_view_com_facebook_login_text);
            this.logoutText = obtainStyledAttributes.getString(C1477R.styleable.com_facebook_login_view_com_facebook_logout_text);
            this.toolTipMode = ToolTipMode.fromInt(obtainStyledAttributes.getInt(C1477R.styleable.com_facebook_login_view_com_facebook_tooltip_mode, ToolTipMode.DEFAULT.getValue()));
        } finally {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (str == null) {
            str = resources.getString(C1477R.string.com_facebook_loginview_log_in_button_continue);
            int measureButtonWidth = measureButtonWidth(str);
            if (resolveSize(measureButtonWidth, i) < measureButtonWidth) {
                str = resources.getString(C1477R.string.com_facebook_loginview_log_in_button);
            }
        }
        int measureButtonWidth2 = measureButtonWidth(str);
        String str2 = this.logoutText;
        if (str2 == null) {
            str2 = resources.getString(C1477R.string.com_facebook_loginview_log_out_button);
        }
    ...
    public void setButtonText() {
        ...
        if (isInEditMode() || !AccessToken.isCurrentAccessTokenActive()) {
            ...
            String string = resources.getString(C1477R.string.com_facebook_loginview_log_in_button_continue);
            int width = getWidth();
            if (width != 0 && measureButtonWidth(string) > width) {
                string = resources.getString(C1477R.string.com_facebook_loginview_log_in_button);
            }
            setText(string);
            return;
        }
    ...
    protected class LoginClickListener implements View.OnClickListener {
        ...
        public void performLogout(Context context) {
            ...
            if (LoginButton.this.confirmLogout) {
                String string = LoginButton.this.getResources().getString(C1477R.string.com_facebook_loginview_log_out_action);
                String string2 = LoginButton.this.getResources().getString(C1477R.string.com_facebook_loginview_cancel_action);
                Profile currentProfile = Profile.getCurrentProfile();
                if (currentProfile == null || currentProfile.getName() == null) {
                    str = LoginButton.this.getResources().getString(C1477R.string.com_facebook_loginview_logged_in_using_facebook);
                } else {
                    str = String.format(LoginButton.this.getResources().getString(C1477R.string.com_facebook_loginview_logged_in_as), new Object[]{currentProfile.getName()});
                }
