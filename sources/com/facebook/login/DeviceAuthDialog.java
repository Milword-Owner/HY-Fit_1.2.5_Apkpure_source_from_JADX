...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        this.dialog = new Dialog(getActivity(), C1388R.C1393style.com_facebook_auth_dialog);
    ...
    public View initializeContentView(boolean z) {
        ...
        this.progressBar = inflate.findViewById(C1388R.C1391id.progress_bar);
        this.confirmationCode = (TextView) inflate.findViewById(C1388R.C1391id.confirmation_code);
        ((Button) inflate.findViewById(C1388R.C1391id.cancel_button)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                DeviceAuthDialog.this.onCancel();
            }
        });
        this.instructions = (TextView) inflate.findViewById(C1388R.C1391id.com_facebook_device_auth_instructions);
        this.instructions.setText(Html.fromHtml(getString(C1388R.string.com_facebook_device_auth_instructions)));
        return inflate;
    }
    ...
    public int getLayoutResId(boolean z) {
        return z ? C1388R.C1392layout.com_facebook_smart_device_dialog_fragment : C1388R.C1392layout.com_facebook_device_auth_dialog_fragment;
    }
    ...
    public void presentConfirmation(String str, Utility.PermissionsLists permissionsLists, String str2, String str3, Date date, Date date2) {
        String string = getResources().getString(C1388R.string.com_facebook_smart_login_confirmation_title);
        String string2 = getResources().getString(C1388R.string.com_facebook_smart_login_confirmation_continue_as);
        String string3 = getResources().getString(C1388R.string.com_facebook_smart_login_confirmation_cancel);
