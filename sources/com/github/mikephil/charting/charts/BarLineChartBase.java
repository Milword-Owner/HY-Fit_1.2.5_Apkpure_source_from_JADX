...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    public void calculateLegendOffsets(RectF rectF) {
        ...
        if (this.mLegend != null && this.mLegend.isEnabled() && !this.mLegend.isDrawInsideEnabled()) {
            int i = C16402.f1542x9c9dbef[this.mLegend.getOrientation().ordinal()];
            if (i == 1) {
                int i2 = C16402.f1541x2787f53e[this.mLegend.getHorizontalAlignment().ordinal()];
                if (i2 == 1) {
                    ...
                    int i3 = C16402.f1543xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
                    if (i3 == 1) {
                ...
                int i4 = C16402.f1543xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
                if (i4 == 1) {
                    rectF.top += Math.min(this.mLegend.mNeededHeight, this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent()) + this.mLegend.getYOffset();
                } else if (i4 == 2) {
                    rectF.bottom += Math.min(this.mLegend.mNeededHeight, this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent()) + this.mLegend.getYOffset();
    ...
    static /* synthetic */ class C16402 {

        /* renamed from: $SwitchMap$com$github$mikephil$charting$components$Legend$LegendHorizontalAlignment */
        static final /* synthetic */ int[] f1541x2787f53e = new int[Legend.LegendHorizontalAlignment.values().length];

        /* renamed from: $SwitchMap$com$github$mikephil$charting$components$Legend$LegendOrientation */
        static final /* synthetic */ int[] f1542x9c9dbef = new int[Legend.LegendOrientation.values().length];

        /* renamed from: $SwitchMap$com$github$mikephil$charting$components$Legend$LegendVerticalAlignment */
        static final /* synthetic */ int[] f1543xc926f1ec = new int[Legend.LegendVerticalAlignment.values().length];
        ...
        static {
            /*
                ...
                f1542x9c9dbef = r0
                r0 = 1
                int[] r1 = f1542x9c9dbef     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                r1 = 2
                int[] r2 = f1542x9c9dbef     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                ...
                int[] r2 = new int[r2]
                f1541x2787f53e = r2
                int[] r2 = f1541x2787f53e     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r2 = f1541x2787f53e     // Catch:{ NoSuchFieldError -> 0x003c }
            ...
            L_0x003c:
                int[] r2 = f1541x2787f53e     // Catch:{ NoSuchFieldError -> 0x0047 }
            ...
            L_0x0047:
                ...
                int[] r2 = new int[r2]
                f1543xc926f1ec = r2
                int[] r2 = f1543xc926f1ec     // Catch:{ NoSuchFieldError -> 0x005a }
            ...
            L_0x005a:
                int[] r0 = f1543xc926f1ec     // Catch:{ NoSuchFieldError -> 0x0064 }
            ...
            L_0x0064:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.BarLineChartBase.C16402.<clinit>():void");
        }
    }
    ...
    public void zoomIn() {
        ...
        this.mViewPortHandler.zoomIn(contentCenter.f1568x, -contentCenter.f1569y, this.mZoomMatrixBuffer);
    ...
    public void zoomOut() {
        MPPointF contentCenter = this.mViewPortHandler.getContentCenter();
        this.mViewPortHandler.zoomOut(contentCenter.f1568x, -contentCenter.f1569y, this.mZoomMatrixBuffer);
        this.mViewPortHandler.refresh(this.mZoomMatrixBuffer, this, false);
        MPPointF.recycleInstance(contentCenter);
        calculateOffsets();
        postInvalidate();
    ...
    public void zoomToCenter(float f, float f2) {
        ...
        this.mViewPortHandler.zoom(f, f2, centerOffsets.f1568x, -centerOffsets.f1569y, matrix);
    ...
    public void zoomAndCenterAnimated(float f, float f2, float f3, float f4, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedZoomJob.getInstance(this.mViewPortHandler, this, getTransformer(axisDependency2), getAxis(axisDependency2), this.mXAxis.mAxisRange, f, f2, this.mViewPortHandler.getScaleX(), this.mViewPortHandler.getScaleY(), f3, f4, (float) valuesByTouchPoint.f1566x, (float) valuesByTouchPoint.f1567y, j));
    ...
    public void moveViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f, f2 + (axisRange / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.f1566x, (float) valuesByTouchPoint.f1567y, j));
        MPPointD.recycleInstance(valuesByTouchPoint);
    }
    ...
    public void centerViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f - (scaleX / 2.0f), f2 + (axisRange / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.f1566x, (float) valuesByTouchPoint.f1567y, j));
        MPPointD.recycleInstance(valuesByTouchPoint);
    }
    ...
    public float getLowestVisibleX() {
        ...
        return (float) Math.max((double) this.mXAxis.mAxisMinimum, this.posForGetLowestVisibleX.f1566x);
    }
    ...
    public float getHighestVisibleX() {
        ...
        return (float) Math.min((double) this.mXAxis.mAxisMaximum, this.posForGetHighestVisibleX.f1566x);
    }
