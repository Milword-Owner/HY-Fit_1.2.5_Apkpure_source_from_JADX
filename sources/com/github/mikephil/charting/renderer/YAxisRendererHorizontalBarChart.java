...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    public void computeAxis(float f, float f2, boolean z) {
        ...
        if (this.mViewPortHandler.contentHeight() > 10.0f && !this.mViewPortHandler.isFullyZoomedOutX()) {
            ...
            if (!z) {
                f3 = (float) valuesByTouchPoint.f1566x;
                d = valuesByTouchPoint2.f1566x;
            } else {
                f3 = (float) valuesByTouchPoint2.f1566x;
                d = valuesByTouchPoint.f1566x;
            }
    ...
    public void drawZeroLine(Canvas canvas) {
        ...
        path.reset();
        path.moveTo(((float) pixelForValues.f1566x) - 1.0f, this.mViewPortHandler.contentTop());
        path.lineTo(((float) pixelForValues.f1566x) - 1.0f, this.mViewPortHandler.contentBottom());
