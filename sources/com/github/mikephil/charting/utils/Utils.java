...
public abstract class Utils {
    ...
    private static final int[] POW_10 = {1, 10, 100, 1000, BleManager.DEFAULT_SCAN_TIME, 100000, 1000000, 10000000, 100000000, 1000000000};
    ...
    public static void drawImage(Canvas canvas, Drawable drawable, int i, int i2, int i3, int i4) {
        ...
        instance.f1568x = (float) (i - (i3 / 2));
        instance.f1569y = (float) (i2 - (i4 / 2));
        ...
        canvas.translate(instance.f1568x, instance.f1569y);
    ...
    public static void drawXAxisValue(Canvas canvas, String str, float f, float f2, Paint paint, MPPointF mPPointF, float f3) {
        ...
        if (f3 != 0.0f) {
            ...
            if (!(mPPointF.f1568x == 0.5f && mPPointF.f1569y == 0.5f)) {
                FSize sizeOfRotatedRectangleByDegrees = getSizeOfRotatedRectangleByDegrees((float) mDrawTextRectBuffer.width(), fontMetrics, f3);
                f -= sizeOfRotatedRectangleByDegrees.width * (mPPointF.f1568x - 0.5f);
                f2 -= sizeOfRotatedRectangleByDegrees.height * (mPPointF.f1569y - 0.5f);
            ...
            if (!(mPPointF.f1568x == 0.0f && mPPointF.f1569y == 0.0f)) {
                f4 -= ((float) mDrawTextRectBuffer.width()) * mPPointF.f1568x;
                f5 -= fontMetrics * mPPointF.f1569y;
            }
    ...
    public static void drawMultilineText(Canvas canvas, StaticLayout staticLayout, float f, float f2, TextPaint textPaint, MPPointF mPPointF, float f3) {
        ...
        if (f3 != 0.0f) {
            ...
            if (!(mPPointF.f1568x == 0.0f && mPPointF.f1569y == 0.0f)) {
                f4 -= width * mPPointF.f1568x;
                f5 -= lineCount * mPPointF.f1569y;
            }
            canvas.save();
