...
/* renamed from: com.huayu.tzc.ui.activity.login.BindLoginActivity$initClick$1 */
/* compiled from: BindLoginActivity.kt */
final class BindLoginActivity$initClick$1 implements View.OnClickListener {
    final /* synthetic */ BindLoginActivity this$0;

    BindLoginActivity$initClick$1(BindLoginActivity bindLoginActivity) {
        this.this$0 = bindLoginActivity;
    }

    public final void onClick(View view) {
        BindLoginActivity bindLoginActivity = this.this$0;
        MyImageView myImageView = (MyImageView) bindLoginActivity._$_findCachedViewById(C2128R.C2131id.loginPassShow);
        ...
        bindLoginActivity.eyeEditText(myImageView, myEditTextView);
    }
}
