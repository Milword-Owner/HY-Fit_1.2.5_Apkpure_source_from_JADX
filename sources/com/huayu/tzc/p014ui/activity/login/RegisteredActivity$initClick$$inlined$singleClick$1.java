...
/* renamed from: com.huayu.tzc.ui.activity.login.RegisteredActivity$initClick$$inlined$singleClick$1 */
/* compiled from: singleClick.kt */
public final class RegisteredActivity$initClick$$inlined$singleClick$1 implements View.OnClickListener {
    final /* synthetic */ View $this_singleClick;
    final /* synthetic */ long $time;
    final /* synthetic */ RegisteredActivity this$0;

    public RegisteredActivity$initClick$$inlined$singleClick$1(View view, long j, RegisteredActivity registeredActivity) {
    ...
    public final void onClick(View view) {
        ...
        if (currentTimeMillis - SingleClickKt.getLastClickTime(this.$this_singleClick) > this.$time || (this.$this_singleClick instanceof Checkable)) {
            ...
            registeredActivity.startActivity(new Intent(registeredActivity, WebActivity.class));
        }
    }
}
