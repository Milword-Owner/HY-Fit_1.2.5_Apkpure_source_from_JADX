...
/* renamed from: com.huayu.tzc.ui.activity.login.BindLoginActivity$initClick$$inlined$singleClick$1 */
/* compiled from: singleClick.kt */
public final class BindLoginActivity$initClick$$inlined$singleClick$1 implements View.OnClickListener {
    final /* synthetic */ View $this_singleClick;
    final /* synthetic */ long $time;
    final /* synthetic */ BindLoginActivity this$0;

    public BindLoginActivity$initClick$$inlined$singleClick$1(View view, long j, BindLoginActivity bindLoginActivity) {
    ...
    public final void onClick(View view) {
        ...
        if (currentTimeMillis - SingleClickKt.getLastClickTime(this.$this_singleClick) > this.$time || (this.$this_singleClick instanceof Checkable)) {
            ...
            BindLoginActivity bindLoginActivity = this.this$0;
            bindLoginActivity.startActivity(new Intent(bindLoginActivity, CodeActivity.class).putExtra(Config.CUSTOM_USER_ID, this.this$0.uid));
        }
    }
}
