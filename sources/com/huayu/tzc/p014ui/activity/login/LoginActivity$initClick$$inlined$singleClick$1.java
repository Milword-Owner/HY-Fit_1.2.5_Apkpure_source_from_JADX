...
/* renamed from: com.huayu.tzc.ui.activity.login.LoginActivity$initClick$$inlined$singleClick$1 */
/* compiled from: singleClick.kt */
public final class LoginActivity$initClick$$inlined$singleClick$1 implements View.OnClickListener {
    final /* synthetic */ View $this_singleClick;
    final /* synthetic */ long $time;
    final /* synthetic */ LoginActivity this$0;

    public LoginActivity$initClick$$inlined$singleClick$1(View view, long j, LoginActivity loginActivity) {
    ...
    public final void onClick(View view) {
        ...
        if (currentTimeMillis - SingleClickKt.getLastClickTime(this.$this_singleClick) > this.$time || (this.$this_singleClick instanceof Checkable)) {
            ...
            loginActivity.startActivity(new Intent(loginActivity, CodeActivity.class));
        }
    }
}
