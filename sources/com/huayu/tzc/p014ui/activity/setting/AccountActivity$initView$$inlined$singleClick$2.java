...
/* renamed from: com.huayu.tzc.ui.activity.setting.AccountActivity$initView$$inlined$singleClick$2 */
/* compiled from: singleClick.kt */
public final class AccountActivity$initView$$inlined$singleClick$2 implements View.OnClickListener {
    final /* synthetic */ View $this_singleClick;
    final /* synthetic */ long $time;
    final /* synthetic */ AccountActivity this$0;

    public AccountActivity$initView$$inlined$singleClick$2(View view, long j, AccountActivity accountActivity) {
    ...
    public final void onClick(View view) {
        ...
        if (currentTimeMillis - SingleClickKt.getLastClickTime(this.$this_singleClick) > this.$time || (this.$this_singleClick instanceof Checkable)) {
            ...
            accountActivity.startActivity(new Intent(accountActivity, LoginActivity.class).setFlags(268468224));
            this.this$0.finish();
        }
    }
}
