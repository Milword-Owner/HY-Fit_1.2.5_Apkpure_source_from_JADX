...
import com.huayu.tzc.adapter.ShareAdapter;
...
import com.huayu.tzc.utils.ImageUtils;
import com.huayu.tzc.utils.RangeUtil;
import com.huayu.tzc.utils.SystemUtil;
...
@Metadata(mo21893bv = {1, 0, 3}, mo21894d1 = {"\u0000T\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0007\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\u0006\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\u0005¢\u0006\u0002\u0010\u0004J\b\u0010\u001a\u001a\u00020\u0006H\u0014J\b\u0010\u001b\u001a\u00020\u0003H\u0016J\b\u0010\u001c\u001a\u00020\u001dH\u0002J\b\u0010\u001e\u001a\u00020\u001dH\u0002J\b\u0010\u001f\u001a\u00020\u001dH\u0014J\b\u0010 \u001a\u00020\u001dH\u0002J\b\u0010!\u001a\u00020\u001dH\u0002J\b\u0010\"\u001a\u00020\u001dH\u0002R\u000e\u0010\u0005\u001a\u00020\u0006X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0006X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u000bX.¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\rX.¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u0006X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0006X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0010\u001a\u00020\u0011X.¢\u0006\u0002\n\u0000R\u0014\u0010\u0012\u001a\b\u0012\u0004\u0012\u00020\u00140\u0013X\u000e¢\u0006\u0002\n\u0000R\u0016\u0010\u0015\u001a\b\u0012\u0004\u0012\u00020\u00170\u0016X\u000e¢\u0006\u0004\n\u0002\u0010\u0018R\u000e\u0010\u0019\u001a\u00020\u0017X\u000e¢\u0006\u0002\n\u0000¨\u0006#"}, mo21895d2 = {"Lcom/huayu/tzc/ui/activity/ShareActivity;", "Lcom/huayu/tzc/base/BaseActivity;", "Lcom/huayu/tzc/contract/MainContract$View;", "Lcom/huayu/tzc/presenter/NotPresenter;", "()V", "age", "", "height", "", "level", "measure", "Lcom/huayu/tzc/bean/Measure;", "member", "Lcom/huayu/tzc/bean/Member;", "num", "sex", "shareAdapter", "Lcom/huayu/tzc/adapter/ShareAdapter;", "shareList", "", "Lcom/huayu/tzc/bean/Share;", "titles", "", "", "[Ljava/lang/String;", "unit", "getLayoutId", "getPresenter", "initAdapter", "", "initData", "initView", "requestImgPermission", "setData", "shareFaceBook", "app_release"}, mo21896k = 1, mo21897mv = {1, 1, 16})
/* renamed from: com.huayu.tzc.ui.activity.ShareActivity */
/* compiled from: ShareActivity.kt */
public final class ShareActivity extends BaseActivity<MainContract.View, NotPresenter> {
    ...
    public int getLayoutId() {
        return C2128R.C2133layout.activity_share;
    }
    ...
    private final void setData() {
        ...
        String format = simpleDateFormat.format(measure2.getMeasureDate());
        Intrinsics.checkExpressionValueIsNotNull(format, "simpleDateFormat.format(measure.getMeasureDate())");
        list.add(new Share(1, member2, format));
        ...
        for (int i = 0; i < length; i++) {
            ...
            switch (i) {
                case 0:
                    ...
                    Intrinsics.checkExpressionValueIsNotNull(strArr, "Constant.COLORS4");
                ...
                case 2:
                    ...
                    break;
                case 3:
                    String[] stringArray2 = getResources().getStringArray(C2128R.array.shape);
                    Intrinsics.checkExpressionValueIsNotNull(stringArray2, "resources.getStringArray(R.array.shape)");
                    int i6 = -1;
                    ...
                    if (i6 >= 0) {
                        historyInfo.setContent(stringArray2[i6], (float) i6, i6, "");
                        break;
                    } else {
            ...
            this.shareList.add(new Share(2, historyInfo));
        }
        this.shareList.add(new Share(3, ""));
        ...
        new Handler().postDelayed(new ShareActivity$setData$1(this), 2000);
    }

    /* access modifiers changed from: private */
    public final void requestImgPermission() {
        XXPermissions.with((FragmentActivity) this).permission(Permission.READ_EXTERNAL_STORAGE).permission(Permission.WRITE_EXTERNAL_STORAGE).request(new ShareActivity$requestImgPermission$1(this));
    }

    /* access modifiers changed from: private */
    public final void shareFaceBook() {
        String str = Environment.getExternalStorageDirectory().toString() + File.separator + "fit" + File.separator + "imageCache" + File.separator + System.currentTimeMillis() + ".jpg";
        Bitmap snapRecyclerView = SystemUtil.snapRecyclerView(this, (RecyclerView) _$_findCachedViewById(C2128R.C2131id.shareRecyclerview));
        Intrinsics.checkExpressionValueIsNotNull(snapRecyclerView, "SystemUtil.snapRecyclerV…ivity, shareRecyclerview)");
        if (!ImageUtils.saveBitmap(this, snapRecyclerView, str)) {
            ToastUtils.show((CharSequence) getString(C2128R.string.jietu_fail));
            progressDissmiss();
            return;
        }
        Platform.ShareParams shareParams = new Platform.ShareParams();
        shareParams.setText(getString(C2128R.string.app_name));
        shareParams.setFilePath(str);
        shareParams.setImagePath(str);
        shareParams.setShareType(2);
        Platform platform = ShareSDK.getPlatform(Facebook.NAME);
        Intrinsics.checkExpressionValueIsNotNull(platform, "platform");
        platform.setPlatformActionListener(new ShareActivity$shareFaceBook$1(this));
        platform.share(shareParams);
    }

    private final void initAdapter() {
        this.shareAdapter = new ShareAdapter(this.shareList);
        RecyclerView recyclerView = (RecyclerView) _$_findCachedViewById(C2128R.C2131id.shareRecyclerview);
        Intrinsics.checkExpressionValueIsNotNull(recyclerView, "shareRecyclerview");
        recyclerView.setLayoutManager(new ShareActivity$initAdapter$1(this, this));
        RecyclerView recyclerView2 = (RecyclerView) _$_findCachedViewById(C2128R.C2131id.shareRecyclerview);
        Intrinsics.checkExpressionValueIsNotNull(recyclerView2, "shareRecyclerview");
        ShareAdapter shareAdapter2 = this.shareAdapter;
        if (shareAdapter2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("shareAdapter");
        }
    ...
    private final void initData() {
        ...
        this.height = (float) member5.getHeight();
        ...
        this.unit = measure3.getWeightunit();
    }
}
