...
import com.huayu.tzc.p014ui.activity.login.RegisteredActivity;
...
/* renamed from: com.huayu.tzc.ui.activity.GuideActivity$initView$$inlined$singleClick$2 */
/* compiled from: singleClick.kt */
public final class GuideActivity$initView$$inlined$singleClick$2 implements View.OnClickListener {
    final /* synthetic */ View $this_singleClick;
    final /* synthetic */ long $time;
    final /* synthetic */ GuideActivity this$0;

    public GuideActivity$initView$$inlined$singleClick$2(View view, long j, GuideActivity guideActivity) {
    ...
    public final void onClick(View view) {
        ...
        if (currentTimeMillis - SingleClickKt.getLastClickTime(this.$this_singleClick) > this.$time || (this.$this_singleClick instanceof Checkable)) {
            ...
            guideActivity.startActivity(new Intent(guideActivity, RegisteredActivity.class));
        }
    }
}
