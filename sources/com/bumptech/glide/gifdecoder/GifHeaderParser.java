...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f1507ix = readShort();
        this.header.currentFrame.f1508iy = readShort();
        this.header.currentFrame.f1506iw = readShort();
        this.header.currentFrame.f1505ih = readShort();
        int read = read();
        boolean z = false;
