...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f1502CR = 13;

    /* renamed from: LF */
    private static final byte f1503LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f1504in;
    private int pos;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f1504in) {
            if (this.buf != null) {
                ...
                C12091 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f1504in;
        byte[] bArr = this.buf;
