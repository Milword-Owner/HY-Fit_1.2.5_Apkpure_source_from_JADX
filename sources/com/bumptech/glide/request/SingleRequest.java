...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r6, com.bumptech.glide.load.DataSource r7) {
        /*
            ...
            r5.loadStatus = r0     // Catch:{ all -> 0x00b2 }
            ...
            java.lang.Class<R> r2 = r5.transcodeClass     // Catch:{ all -> 0x00b2 }
            r7.append(r2)     // Catch:{ all -> 0x00b2 }
        ...
        L_0x002f:
            ...
            goto L_0x005c
        L_0x0042:
            boolean r3 = r5.canSetResource()     // Catch:{ all -> 0x00b2 }
            if (r3 != 0) goto L_0x0057
            r5.resource = r0     // Catch:{ all -> 0x00ba }
        ...
        L_0x0056:
            return
        L_0x0057:
            r5.onResourceReady(r6, r2, r7)     // Catch:{ all -> 0x00b2 }
            monitor-exit(r1)     // Catch:{ all -> 0x00b2 }
            return
        L_0x005c:
            r5.resource = r0     // Catch:{ all -> 0x00ba }
            ...
            java.lang.Class<R> r3 = r5.transcodeClass     // Catch:{ all -> 0x00ba }
            r0.append(r3)     // Catch:{ all -> 0x00ba }
