...
public final class RoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f1524ID = "com.bumptech.glide.load.resource.bitmap.RoundedCorners";
    private static final byte[] ID_BYTES = f1524ID.getBytes(CHARSET);
    ...
    public int hashCode() {
        return Util.hashCode(f1524ID.hashCode(), Util.hashCode(this.roundingRadius));
    }
