...
class DataCacheGenerator implements DataFetcherGenerator, DataFetcher.DataCallback<Object> {
    ...
    /* renamed from: cb */
    private final DataFetcherGenerator.FetcherReadyCallback f1510cb;
    ...
    DataCacheGenerator(List<Key> list, DecodeHelper<?> decodeHelper, DataFetcherGenerator.FetcherReadyCallback fetcherReadyCallback) {
        ...
        this.f1510cb = fetcherReadyCallback;
    }
    ...
    public void onDataReady(Object obj) {
        this.f1510cb.onDataFetcherReady(this.sourceKey, obj, this.loadData.fetcher, DataSource.DATA_DISK_CACHE, this.sourceKey);
    }

    public void onLoadFailed(@NonNull Exception exc) {
        this.f1510cb.onDataFetcherFailed(this.sourceKey, exc, this.loadData.fetcher, DataSource.DATA_DISK_CACHE);
    }
}
