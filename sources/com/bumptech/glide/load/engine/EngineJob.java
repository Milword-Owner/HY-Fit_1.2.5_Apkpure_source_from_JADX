...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0055, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallResourceReady(r5, r1.f1514cb));
     */
    ...
    public void notifyCallbacksOfResult() {
        ...
        L_0x004f:
            ...
            com.bumptech.glide.request.ResourceCallback r1 = r1.f1514cb
            r3.<init>(r1)
            r2.execute(r3)
            goto L_0x004f
        L_0x0068:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x003f, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallLoadFailed(r4, r1.f1514cb));
     */
    ...
    private class CallLoadFailed implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f1512cb;

        CallLoadFailed(ResourceCallback resourceCallback) {
            this.f1512cb = resourceCallback;
        }

        public void run() {
            synchronized (this.f1512cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f1512cb)) {
                        EngineJob.this.callCallbackOnLoadFailed(this.f1512cb);
                    }
    ...
    private class CallResourceReady implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f1513cb;

        CallResourceReady(ResourceCallback resourceCallback) {
            this.f1513cb = resourceCallback;
        }

        public void run() {
            synchronized (this.f1513cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f1513cb)) {
                        EngineJob.this.engineResource.acquire();
                        EngineJob.this.callCallbackOnResourceReady(this.f1513cb);
                        EngineJob.this.removeCallback(this.f1513cb);
                    }
                    EngineJob.this.decrementPendingCallbacks();
                }
            }
    ...
    static final class ResourceCallbackAndExecutor {
        ...
        /* renamed from: cb */
        final ResourceCallback f1514cb;
        final Executor executor;

        ResourceCallbackAndExecutor(ResourceCallback resourceCallback, Executor executor2) {
            this.f1514cb = resourceCallback;
            this.executor = executor2;
        }

        public boolean equals(Object obj) {
            if (obj instanceof ResourceCallbackAndExecutor) {
                return this.f1514cb.equals(((ResourceCallbackAndExecutor) obj).f1514cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f1514cb.hashCode();
        }
    }
