...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, FactoryPools.Poolable {
    ...
    private void runWrapped() {
        int i = C12211.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$RunReason[this.runReason.ordinal()];
        if (i == 1) {
    ...
    private DataFetcherGenerator getNextGenerator() {
        int i = C12211.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[this.stage.ordinal()];
        if (i == 1) {
    ...
    private Stage getNextStage(Stage stage2) {
        int i = C12211.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[stage2.ordinal()];
        if (i != 1) {
            if (i == 2) {
    ...
    public <Z> com.bumptech.glide.load.engine.Resource<Z> onResourceDecoded(com.bumptech.glide.load.DataSource r12, @androidx.annotation.NonNull com.bumptech.glide.load.engine.Resource<Z> r13) {
        ...
        L_0x0042:
            ...
            int[] r12 = com.bumptech.glide.load.engine.DecodeJob.C12211.$SwitchMap$com$bumptech$glide$load$EncodeStrategy
            int r1 = r13.ordinal()
            r12 = r12[r1]
    ...
    static /* synthetic */ class C12211 {
        ...
        static {
            ...
            L_0x0084:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.DecodeJob.C12211.<clinit>():void");
        }
    }
