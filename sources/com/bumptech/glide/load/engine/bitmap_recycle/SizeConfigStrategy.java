...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    private static Bitmap.Config[] getInConfigs(Bitmap.Config config) {
        ...
        int i = C12311.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C12311 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.bitmap_recycle.SizeConfigStrategy.C12311.<clinit>():void");
        }
    }
}
