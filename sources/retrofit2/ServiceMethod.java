    ...
    static final class Builder<T, R> {
        ...
        private Headers parseHeaders(String[] strArr) {
            ...
            for (String str : strArr) {
                ...
                if (com.baidubce.http.Headers.CONTENT_TYPE.equalsIgnoreCase(substring)) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                if (this.isMultipart) {
                    ...
                    if (!value5.isEmpty()) {
                        Headers of = Headers.m1907of(com.baidubce.http.Headers.CONTENT_DISPOSITION, "form-data; name=\"" + value5 + "\"", "Content-Transfer-Encoding", part.encoding());
