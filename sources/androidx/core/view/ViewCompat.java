...
public class ViewCompat {
    private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {C0222R.C0225id.accessibility_custom_action_0, C0222R.C0225id.accessibility_custom_action_1, C0222R.C0225id.accessibility_custom_action_2, C0222R.C0225id.accessibility_custom_action_3, C0222R.C0225id.accessibility_custom_action_4, C0222R.C0225id.accessibility_custom_action_5, C0222R.C0225id.accessibility_custom_action_6, C0222R.C0225id.accessibility_custom_action_7, C0222R.C0225id.accessibility_custom_action_8, C0222R.C0225id.accessibility_custom_action_9, C0222R.C0225id.accessibility_custom_action_10, C0222R.C0225id.accessibility_custom_action_11, C0222R.C0225id.accessibility_custom_action_12, C0222R.C0225id.accessibility_custom_action_13, C0222R.C0225id.accessibility_custom_action_14, C0222R.C0225id.accessibility_custom_action_15, C0222R.C0225id.accessibility_custom_action_16, C0222R.C0225id.accessibility_custom_action_17, C0222R.C0225id.accessibility_custom_action_18, C0222R.C0225id.accessibility_custom_action_19, C0222R.C0225id.accessibility_custom_action_20, C0222R.C0225id.accessibility_custom_action_21, C0222R.C0225id.accessibility_custom_action_22, C0222R.C0225id.accessibility_custom_action_23, C0222R.C0225id.accessibility_custom_action_24, C0222R.C0225id.accessibility_custom_action_25, C0222R.C0225id.accessibility_custom_action_26, C0222R.C0225id.accessibility_custom_action_27, C0222R.C0225id.accessibility_custom_action_28, C0222R.C0225id.accessibility_custom_action_29, C0222R.C0225id.accessibility_custom_action_30, C0222R.C0225id.accessibility_custom_action_31};
    ...
    private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        ArrayList arrayList = (ArrayList) view.getTag(C0222R.C0225id.tag_accessibility_actions);
        if (arrayList != null) {
            return arrayList;
        }
        ArrayList arrayList2 = new ArrayList();
        view.setTag(C0222R.C0225id.tag_accessibility_actions, arrayList2);
        return arrayList2;
    }
    ...
    public static void setPaddingRelative(@NonNull View view, @C0041Px int i, @C0041Px int i2, @C0041Px int i3, @C0041Px int i4) {
        if (Build.VERSION.SDK_INT >= 17) {
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, mo652to = 1.0d) float f) {
        view.setAlpha(f);
    }
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull final OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (Build.VERSION.SDK_INT >= 28) {
            SimpleArrayMap simpleArrayMap = (SimpleArrayMap) view.getTag(C0222R.C0225id.tag_unhandled_key_listeners);
            if (simpleArrayMap == null) {
                simpleArrayMap = new SimpleArrayMap();
                view.setTag(C0222R.C0225id.tag_unhandled_key_listeners, simpleArrayMap);
            }
            C02722 r1 = new View.OnUnhandledKeyEventListener() {
        ...
        ArrayList arrayList = (ArrayList) view.getTag(C0222R.C0225id.tag_unhandled_key_listeners);
        if (arrayList == null) {
            arrayList = new ArrayList();
            view.setTag(C0222R.C0225id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0222R.C0225id.tag_screen_reader_focusable, Boolean.class, 28) {
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0222R.C0225id.tag_accessibility_pane_title, CharSequence.class, 8, 28) {
            /* access modifiers changed from: package-private */
            @RequiresApi(28)
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0222R.C0225id.tag_accessibility_heading, Boolean.class, 28) {
            /* access modifiers changed from: package-private */
            @RequiresApi(28)
            public Boolean frameworkGet(View view) {
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m11at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0222R.C0225id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0222R.C0225id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
