...
public class WindowInsetsCompat {
    ...
    public int getSystemWindowInsetTop() {
        return getSystemWindowInsets().f2821top;
    }
    ...
    public int getStableInsetTop() {
        return getStableInsets().f2821top;
    }
    ...
    public WindowInsetsCompat inset(@NonNull Insets insets) {
        return inset(insets.left, insets.f2821top, insets.right, insets.bottom);
    }
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        int max2 = Math.max(0, insets.f2821top - i2);
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        public void setSystemWindowInsets(@NonNull Insets insets) {
            ...
            if (windowInsets != null) {
                this.mInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f2821top, insets.right, insets.bottom);
            }
        }
