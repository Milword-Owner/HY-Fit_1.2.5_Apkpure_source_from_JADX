...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - DateUtil.DAY_MILL_SECONDS, location.getLatitude(), location.getLongitude());
        ...
        long j6 = j3;
        boolean z2 = z;
        instance.calculateTwilight(DateUtil.DAY_MILL_SECONDS + currentTimeMillis, location.getLatitude(), location.getLongitude());
        long j7 = instance.sunrise;
        if (j6 == -1 || j5 == -1) {
            j = 43200000 + currentTimeMillis;
        } else {
            j = (currentTimeMillis > j5 ? 0 + j7 : currentTimeMillis > j6 ? 0 + j5 : 0 + j6) + DateUtil.MINUTE_MILL_SECONDS;
        }
