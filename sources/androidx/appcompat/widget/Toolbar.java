...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, C0043R.styleable.Toolbar, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), (AttributeSet) null, C0043R.attr.toolbarNavigationButtonStyle);
