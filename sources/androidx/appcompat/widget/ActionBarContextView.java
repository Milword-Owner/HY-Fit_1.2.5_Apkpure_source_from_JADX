...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mCloseItemLayout = obtainStyledAttributes.getResourceId(C0043R.styleable.ActionMode_closeItemLayout, C0043R.C0048layout.abc_action_mode_close_item_material);
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0043R.C0048layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0043R.C0046id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0043R.C0046id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode actionMode) {
        ...
        this.mClose.findViewById(C0043R.C0046id.action_mode_close_button).setOnClickListener(new View.OnClickListener() {
