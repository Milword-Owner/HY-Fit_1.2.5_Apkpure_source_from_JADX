...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0043R.styleable.SearchView_layout, C0043R.C0048layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0043R.C0046id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0043R.C0046id.search_edit_frame);
        this.mSearchPlate = findViewById(C0043R.C0046id.search_plate);
        this.mSubmitArea = findViewById(C0043R.C0046id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0043R.C0046id.search_button);
        this.mGoButton = (ImageView) findViewById(C0043R.C0046id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0043R.C0046id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0043R.C0046id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0043R.C0046id.search_mag_icon);
        ...
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0043R.styleable.SearchView_suggestionRowLayout, C0043R.C0048layout.abc_search_dropdown_item_icons_2line);
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0043R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0043R.dimen.abc_dropdownitem_text_padding_left) : 0;
