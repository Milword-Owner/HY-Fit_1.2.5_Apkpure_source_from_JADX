...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, C0043R.styleable.SwitchCompat, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
        this.mThumbDrawable = obtainStyledAttributes.getDrawable(C0043R.styleable.SwitchCompat_android_thumb);
        Drawable drawable = this.mThumbDrawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        this.mTrackDrawable = obtainStyledAttributes.getDrawable(C0043R.styleable.SwitchCompat_track);
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        if (obtainStyledAttributes.getBoolean(C0043R.styleable.TextAppearance_textAllCaps, false)) {
