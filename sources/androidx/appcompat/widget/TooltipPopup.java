...
class TooltipPopup {
    ...
    TooltipPopup(@NonNull Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0043R.C0048layout.abc_tooltip, (ViewGroup) null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0043R.C0046id.message);
        ...
        layoutParams.windowAnimations = C0043R.C0049style.Animation_AppCompat_Tooltip;
