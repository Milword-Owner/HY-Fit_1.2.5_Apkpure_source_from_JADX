...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0043R.C0046id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0043R.C0046id.edit_query);
        }
    }
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + BceConfig.BOS_DELIMITER + parseInt;
