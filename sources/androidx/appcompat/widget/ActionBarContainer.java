...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        if (getId() == C0043R.C0046id.split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0043R.C0046id.action_bar);
        this.mContextView = findViewById(C0043R.C0046id.action_context_bar);
    }
