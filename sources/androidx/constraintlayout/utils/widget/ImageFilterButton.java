...
public class ImageFilterButton extends AppCompatImageButton {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0207R.styleable.ImageFilterView);
            int indexCount = obtainStyledAttributes.getIndexCount();
            Drawable drawable = obtainStyledAttributes.getDrawable(C0207R.styleable.ImageFilterView_altSrc);
