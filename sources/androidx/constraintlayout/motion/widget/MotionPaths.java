...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    static String[] names = {"position", Config.EVENT_HEAT_X, "y", ViewHierarchyConstants.DIMENSION_WIDTH_KEY, ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, "pathRotate"};
    ...
    public void setView(View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        if (!Float.isNaN(f10)) {
            ...
            double degrees = Math.toDegrees(Math.atan2((double) (f13 + (f14 / 2.0f)), (double) f17));
            Double.isNaN(d3);
            Double.isNaN(d2);
