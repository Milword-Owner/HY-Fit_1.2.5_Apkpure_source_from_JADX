...
public class Debug {
    public static void logStack(String str, String str2, int i) {
        ...
        for (int i2 = 1; i2 <= min; i2++) {
            ...
            str3 = str3 + " ";
            Log.v(str, str2 + str3 + (".(" + stackTrace[i2].getFileName() + Config.TRACE_TODAY_VISIT_SPLIT + stackTrace[i2].getLineNumber() + ") " + stackTrace[i2].getMethodName()) + str3);
        }
    }
    ...
    public static void printStack(String str, int i) {
        ...
        for (int i2 = 1; i2 <= min; i2++) {
            ...
            printStream.println(str + str2 + (".(" + stackTrace[i2].getFileName() + Config.TRACE_TODAY_VISIT_SPLIT + stackTrace[i2].getLineNumber() + ") ") + str2);
        }
    }
    ...
    public static void dumpPoc(Object obj) {
        ...
        String str = ".(" + stackTraceElement.getFileName() + Config.TRACE_TODAY_VISIT_SPLIT + stackTraceElement.getLineNumber() + ")";
    ...
    public static String getLoc() {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        return ".(" + stackTraceElement.getFileName() + Config.TRACE_TODAY_VISIT_SPLIT + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName() + "()";
    }
    ...
    public static void dumpLayoutParams(ViewGroup viewGroup, String str) {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str2 = ".(" + stackTraceElement.getFileName() + Config.TRACE_TODAY_VISIT_SPLIT + stackTraceElement.getLineNumber() + ") " + str + "  ";
