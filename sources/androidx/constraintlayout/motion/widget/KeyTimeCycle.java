...
public class KeyTimeCycle extends Key {
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, C0207R.styleable.KeyTimeCycle));
    }
    ...
    private static class Loader {
        ...
        static {
            mAttrMap.append(C0207R.styleable.KeyTimeCycle_android_alpha, 1);
