...
public abstract class WidgetRun implements Dependency {
    ...
    public final DependencyNode getTarget(ConstraintAnchor constraintAnchor) {
        ...
        int i = C02001.f45x4c44d048[constraintAnchor.mTarget.mType.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C02001 {
        ...
        static final /* synthetic */ int[] f45x4c44d048 = new int[ConstraintAnchor.Type.values().length];
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.widgets.analyzer.WidgetRun.C02001.<clinit>():void");
        }
    }
    ...
    public final DependencyNode getTarget(ConstraintAnchor constraintAnchor, int i) {
        ...
        int i2 = C02001.f45x4c44d048[constraintAnchor.mTarget.mType.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 != 3) {
                    if (i2 != 5) {
