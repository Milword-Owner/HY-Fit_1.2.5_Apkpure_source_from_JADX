...
public class VerticalChainReference extends ChainReference {
    ...
    public void apply() {
        ...
        int i = C01941.$SwitchMap$androidx$constraintlayout$solver$state$State$Chain[this.mStyle.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C01941 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.state.helpers.VerticalChainReference.C01941.<clinit>():void");
        }
    }
