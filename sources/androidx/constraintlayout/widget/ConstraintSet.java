...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintLeft_creator, 82);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintTop_creator, 82);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintRight_creator, 82);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintBottom_creator, 82);
        mapToConstant.append(C0207R.styleable.Constraint_layout_constraintBaseline_creator, 82);
        ...
        mapToConstant.append(C0207R.styleable.Constraint_animate_relativeTo, 64);
    ...
    public static class Layout {
        ...
        static {
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintLeft_toLeftOf, 24);
            ...
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintLeft_creator, 76);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintTop_creator, 76);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintRight_creator, 76);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintBottom_creator, 76);
            mapToConstant.append(C0207R.styleable.Layout_layout_constraintBaseline_creator, 76);
        ...
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0207R.styleable.Layout);
            this.mApply = true;
    ...
    public static class Transform {
        ...
        static {
            mapToConstant.append(C0207R.styleable.Transform_android_rotation, 1);
        ...
        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0207R.styleable.Transform);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public static class PropertySet {
        ...
        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0207R.styleable.PropertySet);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public static class Motion {
        ...
        static {
            mapToConstant.append(C0207R.styleable.Motion_motionPathRotate, 1);
            ...
            mapToConstant.append(C0207R.styleable.Motion_animate_relativeTo, 5);
            mapToConstant.append(C0207R.styleable.Motion_motionStagger, 6);
        }

        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0207R.styleable.Motion);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet) {
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0207R.styleable.Constraint);
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0207R.C0210id.class.getField(trim).getInt((Object) null);
