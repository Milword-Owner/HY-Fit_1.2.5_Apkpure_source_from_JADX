    ...
    static /* synthetic */ class C03921 {
        ...
        static {
            ...
            L_0x0091:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.LifecycleRegistry.C03921.<clinit>():void");
        }
    }

    private static Lifecycle.Event downEvent(Lifecycle.State state) {
        int i = C03921.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
        if (i == 1) {
