...
public class ChangeImageTransform extends Transition {
    ...
    private static Matrix copyImageMatrix(@NonNull ImageView imageView) {
        ...
        if (drawable.getIntrinsicWidth() > 0 && drawable.getIntrinsicHeight() > 0) {
            int i = C05453.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C05453 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ChangeImageTransform.C05453.<clinit>():void");
        }
    }
