...
public abstract class ResourceSubscriber<T> implements FlowableSubscriber<T>, Disposable {
    ...
    /* renamed from: s */
    private final AtomicReference<Subscription> f2765s = new AtomicReference<>();
    ...
    public final void onSubscribe(Subscription subscription) {
        if (EndConsumerHelper.setOnce(this.f2765s, subscription, getClass())) {
    ...
    public final void request(long j) {
        SubscriptionHelper.deferredRequest(this.f2765s, this.missedRequested, j);
    }

    public final void dispose() {
        if (SubscriptionHelper.cancel(this.f2765s)) {
            this.resources.dispose();
        }
    }

    public final boolean isDisposed() {
        return SubscriptionHelper.isCancelled(this.f2765s.get());
    }
}
