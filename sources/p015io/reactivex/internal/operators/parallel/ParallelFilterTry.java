...
public final class ParallelFilterTry<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelFilterSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f2681s, subscription)) {
                this.f2681s = subscription;
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0017:
                ...
                java.lang.Object r6 = p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ Throwable -> 0x004e }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p015io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ Throwable -> 0x004e }
                int[] r7 = p015io.reactivex.internal.operators.parallel.ParallelFilterTry.C25991.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
    ...
    static /* synthetic */ class C25991 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.internal.operators.parallel.ParallelFilterTry.C25991.<clinit>():void");
        }
    }
