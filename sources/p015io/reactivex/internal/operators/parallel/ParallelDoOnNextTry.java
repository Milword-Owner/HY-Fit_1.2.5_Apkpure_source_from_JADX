...
public final class ParallelDoOnNextTry<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelDoOnNextSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f2679s, subscription)) {
                this.f2679s = subscription;
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0014:
                ...
                java.lang.Object r6 = p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ Throwable -> 0x004b }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p015io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ Throwable -> 0x004b }
                int[] r7 = p015io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C25981.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
    ...
    static /* synthetic */ class C25981 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C25981.<clinit>():void");
        }
    }
    ...
    static final class ParallelDoOnNextConditionalSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f2678s, subscription)) {
                this.f2678s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0014:
                ...
                java.lang.String r7 = "The errorHandler returned a null item"
                java.lang.Object r6 = p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ Throwable -> 0x004c }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p015io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ Throwable -> 0x004c }
                int[] r7 = p015io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C25981.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
