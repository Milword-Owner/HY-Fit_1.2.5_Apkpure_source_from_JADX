...
public final class SingleMap<T, R> extends Single<R> {
    ...
    static final class MapSingleObserver<T, R> implements SingleObserver<T> {
        ...
        /* renamed from: t */
        final SingleObserver<? super R> f2712t;

        MapSingleObserver(SingleObserver<? super R> singleObserver, Function<? super T, ? extends R> function) {
            this.f2712t = singleObserver;
            this.mapper = function;
        }

        public void onSubscribe(Disposable disposable) {
            this.f2712t.onSubscribe(disposable);
        }

        public void onSuccess(T t) {
            try {
                this.f2712t.onSuccess(ObjectHelper.requireNonNull(this.mapper.apply(t), "The mapper function returned a null value."));
            } catch (Throwable th) {
