...
public final class FlowableAllSingle<T> extends Single<Boolean> implements FuseToFlowable<Boolean> {
    ...
    static final class AllSubscriber<T> implements FlowableSubscriber<T>, Disposable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f2411s, subscription)) {
                this.f2411s = subscription;
            ...
            if (!this.done) {
                try {
                    if (!this.predicate.test(t)) {
                        this.done = true;
                        this.f2411s.cancel();
                        this.f2411s = SubscriptionHelper.CANCELLED;
        ...
        public boolean isDisposed() {
            return this.f2411s == SubscriptionHelper.CANCELLED;
        }
    }
}
