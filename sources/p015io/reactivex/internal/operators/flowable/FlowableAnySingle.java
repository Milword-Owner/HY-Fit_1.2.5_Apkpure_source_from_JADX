...
public final class FlowableAnySingle<T> extends Single<Boolean> implements FuseToFlowable<Boolean> {
    ...
    static final class AnySubscriber<T> implements FlowableSubscriber<T>, Disposable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f2413s, subscription)) {
                this.f2413s = subscription;
            ...
            if (!this.done) {
                try {
                    if (this.predicate.test(t)) {
                        this.done = true;
                        this.f2413s.cancel();
                        this.f2413s = SubscriptionHelper.CANCELLED;
        ...
        public boolean isDisposed() {
            return this.f2413s == SubscriptionHelper.CANCELLED;
        }
    }
}
