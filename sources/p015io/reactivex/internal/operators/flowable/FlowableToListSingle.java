...
public final class FlowableToListSingle<T, U extends Collection<? super T>> extends Single<U> implements FuseToFlowable<U> {
    ...
    static final class ToListSubscriber<T, U extends Collection<? super T>> implements FlowableSubscriber<T>, Disposable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f2514s, subscription)) {
                this.f2514s = subscription;
        ...
        public void onError(Throwable th) {
            this.value = null;
            this.f2514s = SubscriptionHelper.CANCELLED;
        ...
        public boolean isDisposed() {
            return this.f2514s == SubscriptionHelper.CANCELLED;
        }
    }
}
