...
public final class FlowableWindow<T> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    static final class WindowExactSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f2517s, subscription)) {
                this.f2517s = subscription;
        ...
        public void request(long j) {
            if (SubscriptionHelper.validate(j)) {
                this.f2517s.request(BackpressureHelper.multiplyCap(this.size, j));
            }
        }
    ...
    static final class WindowSkipSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f2519s, subscription)) {
                this.f2519s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        public void request(long j) {
            ...
            if (this.firstRequest.get() || !this.firstRequest.compareAndSet(false, true)) {
                this.f2519s.request(BackpressureHelper.multiplyCap(this.skip, j));
                return;
            }
            this.f2519s.request(BackpressureHelper.addCap(BackpressureHelper.multiplyCap(this.size, j), BackpressureHelper.multiplyCap(this.skip - this.size, j - 1)));
        }
    ...
    static final class WindowOverlapSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T>, Subscription, Runnable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f2518s, subscription)) {
                this.f2518s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        public void request(long j) {
            if (SubscriptionHelper.validate(j)) {
                ...
                if (this.firstRequest.get() || !this.firstRequest.compareAndSet(false, true)) {
                    this.f2518s.request(BackpressureHelper.multiplyCap(this.skip, j));
                } else {
                    this.f2518s.request(BackpressureHelper.addCap(this.size, BackpressureHelper.multiplyCap(this.skip, j - 1)));
                }
                drain();
            }
        }
