...
public final class FlowableFlattenIterable<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    static final class FlattenIterableSubscriber<T, R> extends BasicIntQueueSubscription<R> implements FlowableSubscriber<T> {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f2454s, subscription)) {
                this.f2454s = subscription;
        ...
        public void drain() {
            ...
            L_0x004a:
                ...
                org.reactivestreams.Subscription r3 = r1.f2454s
                r3.cancel()
            ...
            L_0x0062:
                ...
                org.reactivestreams.Subscription r0 = r1.f2454s
                r0.cancel()
                java.util.concurrent.atomic.AtomicReference<java.lang.Throwable> r0 = r1.error
            ...
            L_0x0098:
                ...
                java.lang.Object r5 = p015io.reactivex.internal.functions.ObjectHelper.requireNonNull(r15, (java.lang.String) r5)     // Catch:{ Throwable -> 0x00dc }
                r2.onNext(r5)
                boolean r5 = r1.done
