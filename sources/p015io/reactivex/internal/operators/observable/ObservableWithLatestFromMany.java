...
public final class ObservableWithLatestFromMany<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    static final class WithLatestFromObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        /* renamed from: d */
        final AtomicReference<Disposable> f2675d;
        ...
        WithLatestFromObserver(Observer<? super R> observer, Function<? super Object[], R> function, int i) {
            ...
            this.f2675d = new AtomicReference<>();
        ...
        public void subscribe(ObservableSource<?>[] observableSourceArr, int i) {
            ...
            AtomicReference<Disposable> atomicReference = this.f2675d;
        ...
        public void onSubscribe(Disposable disposable) {
            DisposableHelper.setOnce(this.f2675d, disposable);
        }
        ...
        public boolean isDisposed() {
            return DisposableHelper.isDisposed(this.f2675d.get());
        }

        public void dispose() {
            DisposableHelper.dispose(this.f2675d);
