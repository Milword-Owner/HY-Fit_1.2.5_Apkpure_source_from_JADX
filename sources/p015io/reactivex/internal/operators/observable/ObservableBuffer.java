...
public final class ObservableBuffer<T, U extends Collection<? super T>> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class BufferExactObserver<T, U extends Collection<? super T>> implements Observer<T>, Disposable {
        ...
        public boolean createBuffer() {
            try {
                ...
                this.buffer = null;
                Disposable disposable = this.f2568s;
                if (disposable == null) {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f2568s, disposable)) {
                this.f2568s = disposable;
    ...
    static final class BufferSkipObserver<T, U extends Collection<? super T>> extends AtomicBoolean implements Observer<T>, Disposable {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f2569s, disposable)) {
                this.f2569s = disposable;
                this.actual.onSubscribe(this);
            }
        }
