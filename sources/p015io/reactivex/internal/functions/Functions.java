...
public final class Functions {
    ...
    static final class Array2Func<T1, T2, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final BiFunction<? super T1, ? super T2, ? extends R> f2361f;

        Array2Func(BiFunction<? super T1, ? super T2, ? extends R> biFunction) {
            this.f2361f = biFunction;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 2) {
                return this.f2361f.apply(objArr[0], objArr[1]);
            }
    ...
    static final class Array3Func<T1, T2, T3, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function3<T1, T2, T3, R> f2362f;

        Array3Func(Function3<T1, T2, T3, R> function3) {
            this.f2362f = function3;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 3) {
                return this.f2362f.apply(objArr[0], objArr[1], objArr[2]);
            }
    ...
    static final class Array4Func<T1, T2, T3, T4, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function4<T1, T2, T3, T4, R> f2363f;

        Array4Func(Function4<T1, T2, T3, T4, R> function4) {
            this.f2363f = function4;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 4) {
                return this.f2363f.apply(objArr[0], objArr[1], objArr[2], objArr[3]);
            }
    ...
    static final class Array5Func<T1, T2, T3, T4, T5, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        private final Function5<T1, T2, T3, T4, T5, R> f2364f;

        Array5Func(Function5<T1, T2, T3, T4, T5, R> function5) {
            this.f2364f = function5;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 5) {
                return this.f2364f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4]);
            }
    ...
    static final class Array6Func<T1, T2, T3, T4, T5, T6, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function6<T1, T2, T3, T4, T5, T6, R> f2365f;

        Array6Func(Function6<T1, T2, T3, T4, T5, T6, R> function6) {
            this.f2365f = function6;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 6) {
                return this.f2365f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5]);
            }
    ...
    static final class Array7Func<T1, T2, T3, T4, T5, T6, T7, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function7<T1, T2, T3, T4, T5, T6, T7, R> f2366f;

        Array7Func(Function7<T1, T2, T3, T4, T5, T6, T7, R> function7) {
            this.f2366f = function7;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 7) {
                return this.f2366f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6]);
            }
    ...
    static final class Array8Func<T1, T2, T3, T4, T5, T6, T7, T8, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> f2367f;

        Array8Func(Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> function8) {
            this.f2367f = function8;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 8) {
                return this.f2367f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7]);
            }
    ...
    static final class Array9Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> f2368f;

        Array9Func(Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> function9) {
            this.f2368f = function9;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 9) {
                return this.f2368f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7], objArr[8]);
            }
