...
public abstract class ResourceObserver<T> implements Observer<T>, Disposable {
    ...
    /* renamed from: s */
    private final AtomicReference<Disposable> f2757s = new AtomicReference<>();
    ...
    public final void onSubscribe(Disposable disposable) {
        if (EndConsumerHelper.setOnce(this.f2757s, disposable, getClass())) {
            onStart();
        }
    }

    public final void dispose() {
        if (DisposableHelper.dispose(this.f2757s)) {
            this.resources.dispose();
        }
    }

    public final boolean isDisposed() {
        return DisposableHelper.isDisposed(this.f2757s.get());
    }
}
