...
public class WebViewAppLinkResolver implements AppLinkResolver {
                ...
                while (url != null) {
                    ...
                    if (z) {
                        ...
                        if (httpURLConnection.getResponseCode() >= 300 && httpURLConnection.getResponseCode() < 400) {
                            URL url2 = new URL(httpURLConnection.getHeaderField(Headers.LOCATION));
    ...
    public static Map<String, Object> parseAlData(JSONArray jSONArray) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            String[] split = jSONObject.getString("property").split(Config.TRACE_TODAY_VISIT_SPLIT);
    ...
    public static AppLink makeAppLinkFromAlData(Map<String, Object> map, Uri uri) {
        ...
        if (list2 == null || list2.size() <= 0) {
            ...
            if (list4 == null || list4.size() <= 0 || !Arrays.asList(new String[]{"no", "false", "0"}).contains(((String) ((Map) list4.get(0)).get(KEY_AL_VALUE)).toLowerCase())) {
                uri2 = uri;
            }
            uri3 = (uri2 == null || list3 == null || list3.size() <= 0) ? uri2 : tryCreateUrl((String) ((Map) list3.get(0)).get(KEY_AL_VALUE));
        }
