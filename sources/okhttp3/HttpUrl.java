...
public final class HttpUrl {
    ...
    static HttpUrl getChecked(String str) throws MalformedURLException, UnknownHostException {
        ...
        int i = C16851.$SwitchMap$okhttp3$HttpUrl$Builder$ParseResult[parse.ordinal()];
        if (i == 1) {
            return builder.build();
        }
        if (i != 2) {
    ...
    static /* synthetic */ class C16851 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.HttpUrl.C16851.<clinit>():void");
        }
    }
