    ...
    private static final class Entry {
        ...
        private void writeCertList(BufferedSink bufferedSink, List<Certificate> list) throws IOException {
            try {
                ...
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    bufferedSink.writeUtf8(ByteString.m1909of(list.get(i).getEncoded()).base64()).writeByte(10);
                }
        ...
        public Response response(DiskLruCache.Snapshot snapshot) {
            String str = this.responseHeaders.get(com.baidubce.http.Headers.CONTENT_TYPE);
            String str2 = this.responseHeaders.get(com.baidubce.http.Headers.CONTENT_LENGTH);
