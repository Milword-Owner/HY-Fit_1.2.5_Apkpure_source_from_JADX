...
public final class HttpHeaders {
    ...
    public static long contentLength(Headers headers) {
        return stringToLong(headers.get(com.baidubce.http.Headers.CONTENT_LENGTH));
    }
    ...
    public static boolean hasBody(Response response) {
        ...
        if (((code >= 100 && code < 200) || code == 204 || code == 304) && contentLength(response) == -1 && !"chunked".equalsIgnoreCase(response.header(com.baidubce.http.Headers.TRANSFER_ENCODING))) {
            return false;
        }
        return true;
    }
