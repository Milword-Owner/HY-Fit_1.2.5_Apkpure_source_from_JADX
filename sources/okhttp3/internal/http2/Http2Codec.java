...
public final class Http2Codec implements HttpCodec {
    ...
    private static final List<ByteString> HTTP_2_SKIPPED_REQUEST_HEADERS = Util.immutableList((T[]) new ByteString[]{CONNECTION, HOST, KEEP_ALIVE, PROXY_CONNECTION, f2788TE, TRANSFER_ENCODING, ENCODING, UPGRADE, Header.TARGET_METHOD, Header.TARGET_PATH, Header.TARGET_SCHEME, Header.TARGET_AUTHORITY});
    private static final List<ByteString> HTTP_2_SKIPPED_RESPONSE_HEADERS = Util.immutableList((T[]) new ByteString[]{CONNECTION, HOST, KEEP_ALIVE, PROXY_CONNECTION, f2788TE, TRANSFER_ENCODING, ENCODING, UPGRADE});
    private static final ByteString KEEP_ALIVE = ByteString.encodeUtf8("keep-alive");
    private static final ByteString PROXY_CONNECTION = ByteString.encodeUtf8("proxy-connection");

    /* renamed from: TE */
    private static final ByteString f2788TE = ByteString.encodeUtf8("te");
    ...
    public static List<Header> http2HeadersList(Request request) {
        ...
        String header = request.header(com.baidubce.http.Headers.HOST);
        if (header != null) {
    ...
    public ResponseBody openResponseBody(Response response) throws IOException {
        ...
        return new RealResponseBody(response.header(com.baidubce.http.Headers.CONTENT_TYPE), HttpHeaders.contentLength(response), Okio.buffer((Source) new StreamFinishingSource(this.stream.getSource())));
    }
