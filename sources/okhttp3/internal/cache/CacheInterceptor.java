...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(response.header(Headers.CONTENT_TYPE), response.body().contentLength(), Okio.buffer((Source) r2))).build();
    }
    ...
    static boolean isEndToEnd(String str) {
        return !"Connection".equalsIgnoreCase(str) && !"Keep-Alive".equalsIgnoreCase(str) && !"Proxy-Authenticate".equalsIgnoreCase(str) && !"Proxy-Authorization".equalsIgnoreCase(str) && !"TE".equalsIgnoreCase(str) && !"Trailers".equalsIgnoreCase(str) && !com.baidubce.http.Headers.TRANSFER_ENCODING.equalsIgnoreCase(str) && !"Upgrade".equalsIgnoreCase(str);
    }

    static boolean isContentSpecificHeader(String str) {
        return com.baidubce.http.Headers.CONTENT_LENGTH.equalsIgnoreCase(str) || com.baidubce.http.Headers.CONTENT_ENCODING.equalsIgnoreCase(str) || com.baidubce.http.Headers.CONTENT_TYPE.equalsIgnoreCase(str);
    }
}
