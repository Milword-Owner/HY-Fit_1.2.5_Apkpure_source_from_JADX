...
public final class MultipartBody extends RequestBody {
    ...
    public static final class Part {
        ...
        public static Part create(@Nullable Headers headers2, RequestBody requestBody) {
            ...
            } else if (headers2 != null && headers2.get(Headers.CONTENT_TYPE) != null) {
                throw new IllegalArgumentException("Unexpected header: Content-Type");
            } else if (headers2 == null || headers2.get(Headers.CONTENT_LENGTH) == null) {
        ...
        public static Part createFormData(String str, @Nullable String str2, RequestBody requestBody) {
            if (str != null) {
                ...
                return create(Headers.m1907of(Headers.CONTENT_DISPOSITION, sb.toString()), requestBody);
            }
